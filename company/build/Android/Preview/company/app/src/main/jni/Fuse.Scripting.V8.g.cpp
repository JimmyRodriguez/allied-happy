...
// /usr/local/share/uno/Packages/Fuse.Scripting.V8/0.35.8/$.uno
// ------------------------------------------------------------
...
static void Debugger__Connected_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("/usr/local/share/uno/Packages/Fuse.Scripting.V8/0.35.8/$.uno");
...
static void Debugger_build(uType* type)
{
    ...
    ::STRINGS[22] = uString::Const("0.35.8");
