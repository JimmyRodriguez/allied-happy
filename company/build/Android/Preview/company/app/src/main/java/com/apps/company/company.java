...
//#else
public class company extends android.app.Activity implements ActivityCompat.OnRequestPermissionsResultCallback
//#endif
{
...
//#endif
    ...
    {
    	company activity = _appState.CurrentActivity;
...
public static native void __n_onLowMemory();
    ...
    public static company RootActivity()
    {
        return _appState.CurrentActivity;
    }
