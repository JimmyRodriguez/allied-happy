// This file was generated based on '/Users/jimmysidney/workspace/apps-fuse/company/build/Android/Preview/preamble/$.uno'.
...
{
    ::STRINGS[0] = uString::Const("192.168.10.137");
    ::STRINGS[1] = uString::Const("127.0.0.1");
    ::STRINGS[2] = uString::Const("/Users/jimmysidney/workspace/apps-fuse/company/company.unoproj");
    ::STRINGS[3] = uString::Const("company");
...
::g::Uno::IO::Bundle* GeneratedApplication::GetBundle()
{
    ...
    return ::g::Uno::IO::Bundle::Get(::STRINGS[3/*"company"*/]);
}
