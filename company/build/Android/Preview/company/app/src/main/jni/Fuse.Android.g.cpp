...
// /usr/local/share/uno/Packages/Fuse.Android/0.35.8/Internal/$.uno
// ----------------------------------------------------------------
...
// internal static extern class AppRoot :712
// {
// static AppRoot() :735
...
// public static void Clear(Fuse.Controls.Native.Android.View view) [static] :764
...
// private static void ClearRootView(Java.Object handle) [static] :794
...
// private static Java.Object CreateRootView() [static] :800
...
// private static void OnTouchEvent__(Java.Object motionEvent) [static] :781
...
// public static void Set(Fuse.Controls.Native.Android.View view) [static] :754
...
// private static void SetAppRoot(Java.Object rootView) [static] :773
...
// private static void SetChildSize(Fuse.Controls.Native.Android.View view, float2 size) [static] :742
...
// private static void SetChildSize(Java.Object handle, int w, int h) [static] :748
...
// private static void SetRootView(Java.Object handle, Java.Object rootHandle) [static] :788
...
// private sealed class AppRoot.AppRootParent :715
// {
...
// public AppRootParent(Uno.Action<Fuse.Controls.Native.Android.View, float2> setChildSize) :720
void AppRoot__AppRootParent__ctor__fn(AppRoot__AppRootParent* __this, uDelegate* setChildSize)
{
    __this->ctor_(setChildSize);
}

// private void Fuse.Controls.Native.Android.IViewParent.SetChildSize(Fuse.Controls.Native.Android.View view, float2 size) :725
...
// public AppRootParent New(Uno.Action<Fuse.Controls.Native.Android.View, float2> setChildSize) :720
...
// public AppRootParent(Uno.Action<Fuse.Controls.Native.Android.View, float2> setChildSize) [instance] :720
...
// public AppRootParent New(Uno.Action<Fuse.Controls.Native.Android.View, float2> setChildSize) [static] :720
...
// private sealed class TextRenderer.BackgroundRender :442
// {
...
// public BackgroundRender(Fuse.Android.TextRenderer textRenderer, ulong textureVersion, Fuse.Android.StaticLayout layout, float4 renderColor, Uno.Recti pixelBounds) :451
...
// public BackgroundRender New(Fuse.Android.TextRenderer textRenderer, ulong textureVersion, Fuse.Android.StaticLayout layout, float4 renderColor, Uno.Recti pixelBounds) :451
...
// public void UpdateTextureAsync() :460
...
// public BackgroundRender(Fuse.Android.TextRenderer textRenderer, ulong textureVersion, Fuse.Android.StaticLayout layout, float4 renderColor, Uno.Recti pixelBounds) [instance] :451
...
// public void UpdateTextureAsync() [instance] :460
...
// public BackgroundRender New(Fuse.Android.TextRenderer textRenderer, ulong textureVersion, Fuse.Android.StaticLayout layout, float4 renderColor, Uno.Recti pixelBounds) [static] :451
...
// internal sealed class Blitter :513
// {
// static Blitter() :513
...
// public generated Blitter() :513
void Blitter__ctor__fn(Blitter* __this)
{
    __this->ctor_();
}

// public void Blit(texture2D vt, float2 pos, float2 size, float4x4 localToClipTransform) :517
...
// private generated void init_DrawCalls() :513
void Blitter__init_DrawCalls_fn(Blitter* __this)
{
    __this->init_DrawCalls();
}

// public generated Blitter New() :513
...
// public generated Blitter() [instance] :513
void Blitter::ctor_()
{
...
// public void Blit(texture2D vt, float2 pos, float2 size, float4x4 localToClipTransform) [instance] :517
...
// private generated void init_DrawCalls() [instance] :513
...
// public generated Blitter New() [static] :513
...
// public void Draw(Fuse.DrawContext dc, Fuse.Visual where) :506
...
// private void SetTexture(OpenGL.GLTextureHandle newTexture) :369
...
// private OpenGL.GLTextureHandle UpdateTexture(Fuse.Android.StaticLayout layout, float4 renderColor, Uno.Recti pixelBounds) :421
...
// public void Draw(Fuse.DrawContext dc, Fuse.Visual where) [instance] :506
...
// private void SetTexture(OpenGL.GLTextureHandle newTexture) [instance] :369
...
// private OpenGL.GLTextureHandle UpdateTexture(Fuse.Android.StaticLayout layout, float4 renderColor, Uno.Recti pixelBounds) [instance] :421
