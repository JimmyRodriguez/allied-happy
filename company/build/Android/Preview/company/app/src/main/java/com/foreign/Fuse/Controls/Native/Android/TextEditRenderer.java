...
public class TextEditRenderer
{
    ...
    {
        android.widget.GridLayout gridLayout = new android.widget.GridLayout(com.apps.company.company.GetRootActivity());
    ...
    {
        android.widget.TextView tv = new android.widget.TextView(com.apps.company.company.GetRootActivity());
