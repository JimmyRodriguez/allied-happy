...
jint JNI_OnLoad(JavaVM* vm, void* reserved)
{
    ...
    jclass activityClass = env->FindClass("com/apps/company/company");
    jclass entryPointsClass = env->FindClass("com/apps/company/ActivityNativeEntryPoints");
    jclass displayClass = env->FindClass("com/apps/company/Display");
