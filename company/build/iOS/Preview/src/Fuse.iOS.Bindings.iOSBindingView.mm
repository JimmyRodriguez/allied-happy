...
// public static float2 GetContentSize(iOS.UIKit.UIView view, Fuse.LayoutParams lp) :367
...
// public static Uno.Platform.ViewNativeHandle GetNativeViewHandle(iOS.UIKit.UIView view) :372
...
// public static void SetFrame(iOS.UIKit.UIView view, Uno.Rect frame) :362
void iOSBindingView__SetFrame_fn(::g::iOS::UIKit::UIView* view, ::g::Uno::Rect* frame)
{
    iOSBindingView::SetFrame(view, *frame);
}

// public static float2 GetContentSize(iOS.UIKit.UIView view, Fuse.LayoutParams lp) [static] :367
...
// public static Uno.Platform.ViewNativeHandle GetNativeViewHandle(iOS.UIKit.UIView view) [static] :372
...
// public static void SetFrame(iOS.UIKit.UIView view, Uno.Rect frame) [static] :362
