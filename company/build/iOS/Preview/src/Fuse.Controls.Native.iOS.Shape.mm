...
// internal abstract extern class Shape :1860
// {
static void Shape_build(uType* type)
{
    ::STRINGS[0] = uString::Const("");
    ::STRINGS[1] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Native/0.35.8/iOS/$.uno");
...
// private void Fuse.Controls.Native.IShapeView.Update(Fuse.Drawing.Brush[] fills, Fuse.Drawing.Stroke[] strokes, float pixelsPerPoint) :1901
...
// private static void MakeLayers(ObjC.Object handle, int layerCount) :2089
void Shape__MakeLayers_fn(uObject* handle, int* layerCount)
{
    Shape::MakeLayers(handle, *layerCount);
}

// protected void OnShapeChanged() :1907
void Shape__OnShapeChanged_fn(Shape* __this)
{
    __this->OnShapeChanged();
}

// private static int SelectOffset(Fuse.Drawing.GradientStop a, Fuse.Drawing.GradientStop b) :1959
...
// private void SetBrush(Fuse.Drawing.Brush brush, int layer, ObjC.Object path, bool isLine, float strokeWidth) :1935
...
// private static void SetBrush(ObjC.Object handle, float r, float g, float b, float a, int layerIndex, ObjC.Object pathHandle, bool isLine, float strokeWidth, float opacity) :2067
...
// private void SetLinearGradient(Fuse.Drawing.LinearGradient gradient, int layer, ObjC.Object path, bool isLine, float strokeWidth) :1964
...
// private static void SetLinearGradient(ObjC.Object handle, int layerIndex, ObjC.Object pathHandle, bool isLine, float strokeWidth, float startX, float startY, float endX, float endY, float[] colors, float[] offsets, float width, float height) :1996
...
// public override sealed void set_Transform(float4x4 value) :1880
...
// protected Shape(Fuse.Visual visual) [instance] :1865
...
// protected void OnShapeChanged() [instance] :1907
...
// private void SetBrush(Fuse.Drawing.Brush brush, int layer, ObjC.Object path, bool isLine, float strokeWidth) [instance] :1935
void Shape::SetBrush(::g::Fuse::Drawing::Brush* brush, int layer, uObject* path, bool isLine, float strokeWidth)
{
    ...
    else
    {
        ...
        if ((sc == NULL) && (ssc == NULL))
            ::g::Fuse::Diagnostics::Unsupported(::STRINGS[0/*""*/], brush, ::STRINGS[1/*"/usr/local/...*/], 1952, ::STRINGS[2/*"SetBrush"*/]);
...
// private void SetLinearGradient(Fuse.Drawing.LinearGradient gradient, int layer, ObjC.Object path, bool isLine, float strokeWidth) [instance] :1964
...
// protected generated float2 get_ShapePosition() [instance] :1877
...
// private generated void set_ShapePosition(float2 value) [instance] :1877
...
// protected generated float2 get_ShapeSize() [instance] :1888
...
// private generated void set_ShapeSize(float2 value) [instance] :1888
...
// private static ObjC.Object Create() [static] :2105
...
// private static void MakeLayers(ObjC.Object handle, int layerCount) [static] :2089
...
// private static int SelectOffset(Fuse.Drawing.GradientStop a, Fuse.Drawing.GradientStop b) [static] :1959
...
// private static void SetBrush(ObjC.Object handle, float r, float g, float b, float a, int layerIndex, ObjC.Object pathHandle, bool isLine, float strokeWidth, float opacity) [static] :2067
...
// private static void SetLinearGradient(ObjC.Object handle, int layerIndex, ObjC.Object pathHandle, bool isLine, float strokeWidth, float startX, float startY, float endX, float endY, float[] colors, float[] offsets, float width, float height) [static] :1996
