...
// private static void BeginDraw(ObjC.Object handle, int x, int y) :559
...
// private static void DeleteDrawable(ObjC.Object handle) :594
void GraphicsView__DeleteDrawable_fn(uObject* handle)
{
    GraphicsView::DeleteDrawable(handle);
}

// public override sealed void Dispose() :586
...
// private static void EndDraw(ObjC.Object handle) :580
void GraphicsView__EndDraw_fn(uObject* handle)
{
    GraphicsView::EndDraw(handle);
}

// private void Fuse.Controls.Native.IGraphicsView.BeginDraw(int2 size) :554
...
// private static void BeginDraw(ObjC.Object handle, int x, int y) [static] :559
...
// private static void DeleteDrawable(ObjC.Object handle) [static] :594
...
// private static void EndDraw(ObjC.Object handle) [static] :580
