...
// internal sealed extern class Rectangle :1583
// {
...
Rectangle_type* Rectangle_typeof()
{
    ...
    type->SetBase(::g::Fuse::Controls::Native::iOS::Shape_typeof());
...
// public Rectangle(Fuse.Visual visual) :1586
void Rectangle__ctor_2_fn(Rectangle* __this, ::g::Fuse::Visual* visual)
{
    __this->ctor_2(visual);
}

// private void AddArcWithCenter(ObjC.Object handle, float centerX, float centerY, float radius, float startAngle, float endAngle) :1672
...
// private static ObjC.Object CreateUIBezierPath() :1645
void Rectangle__CreateUIBezierPath_fn(uObject** __retval)
{
    *__retval = Rectangle::CreateUIBezierPath();
}

// private void Fuse.Controls.Native.IRectangleView.set_CornerRadius(float4 value) :1594
...
// private void AddArcWithCenter(ObjC.Object handle, float centerX, float centerY, float radius, float startAngle, float endAngle) [instance] :1672
...
// private void AddLineToPoint(ObjC.Object handle, float x, float y) [instance] :1665
...
// private void ClosePath(ObjC.Object handle) [instance] :1651
...
// private void MoveToPoint(ObjC.Object handle, float x, float y) [instance] :1658
...
// private static ObjC.Object CreateUIBezierPath() [static] :1645
...
// public Rectangle New(Fuse.Visual visual) [static] :1586
