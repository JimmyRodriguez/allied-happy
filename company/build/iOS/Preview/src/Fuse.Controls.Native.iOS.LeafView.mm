...
// public abstract extern class LeafView :1325
// {
...
// protected LeafView(ObjC.Object handle) :1328
void LeafView__ctor_1_fn(LeafView* __this, uObject* handle)
{
    __this->ctor_1(handle);
}

// public float2 Measure(Fuse.LayoutParams lp, float density) :1330
...
// private static void SizeThatFits(ObjC.Object handle, float w, float h, float& resW, float& resH) :1349
...
// protected LeafView(ObjC.Object handle) [instance] :1328
...
// public float2 Measure(Fuse.LayoutParams lp, float density) [instance] :1330
...
// private static void SizeThatFits(ObjC.Object handle, float w, float h, float& resW, float& resH) [static] :1349
