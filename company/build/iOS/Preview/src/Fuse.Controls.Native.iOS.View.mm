...
{
    ::STRINGS[0] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Native/0.35.8/iOS/$.uno");
...
// public void Hide() :3344
void View__Hide_fn(View* __this)
{
    __this->Hide();
}

// public static void Hide(ObjC.Object handle) :3359
void View__Hide1_fn(uObject* handle)
{
    View::Hide1(handle);
}

// public void set_IsEnabled(bool value) :3389
void View__set_IsEnabled_fn(View* __this, bool* value)
{
    __this->IsEnabled(*value);
}

// public void set_Opacity(float value) :3384
void View__set_Opacity_fn(View* __this, float* value)
{
    __this->Opacity(*value);
}

// internal Fuse.Controls.Native.iOS.ViewParent get_Parent() :3252
void View__get_Parent_fn(View* __this, ::g::Fuse::Controls::Native::iOS::ViewParent** __retval)
{
    *__retval = __this->Parent();
}

// internal void set_Parent(Fuse.Controls.Native.iOS.ViewParent value) :3253
void View__set_Parent_fn(View* __this, ::g::Fuse::Controls::Native::iOS::ViewParent* value)
{
    __this->Parent(value);
}

// public void set_Position(float2 value) :3324
void View__set_Position_fn(View* __this, ::g::Uno::Float2* value)
{
    __this->Position(*value);
}

// private static void SetAlpha(ObjC.Object handle, float a) :3400
void View__SetAlpha_fn(uObject* handle, float* a)
{
    View::SetAlpha(handle, *a);
}

// public static void SetAnchorPoint(ObjC.Object handle) :3270
void View__SetAnchorPoint_fn(uObject* handle)
{
    View::SetAnchorPoint(handle);
}

// private static void SetBackground(ObjC.Object handle, float r, float g, float b, float a) :3450
void View__SetBackground_fn(uObject* handle, float* r, float* g, float* b, float* a)
{
    View::SetBackground(handle, *r, *g, *b, *a);
}

// public static void SetBounds(ObjC.Object handle, float x, float y, float w, float h) :3417
void View__SetBounds_fn(uObject* handle, float* x, float* y, float* w, float* h)
{
    View::SetBounds(handle, *x, *y, *w, *h);
}

// private static void SetClipToBounds(ObjC.Object handle, bool clipToBounds) :3282
void View__SetClipToBounds_fn(uObject* handle, bool* clipToBounds)
{
    View::SetClipToBounds(handle, *clipToBounds);
}

// private static void SetSize(ObjC.Object handle, float w, float h) :3407
void View__SetSize_fn(uObject* handle, float* w, float* h)
{
    View::SetSize(handle, *w, *h);
}

// public static void SetTransform(ObjC.Object handle, float m11, float m12, float m13, float m14, float m21, float m22, float m23, float m24, float m31, float m32, float m33, float m34, float m41, float m42, float m43, float m44) :3433
...
// public static void SetTransform(ObjC.Object handle, float4x4 t) :3423
void View__SetTransform1_fn(uObject* handle, ::g::Uno::Float4x4* t)
{
    View::SetTransform1(handle, *t);
}

// private static void SetUserInteractionEnabled(ObjC.Object handle, bool enabled) :3393
void View__SetUserInteractionEnabled_fn(uObject* handle, bool* enabled)
{
    View::SetUserInteractionEnabled(handle, *enabled);
}

// public void Show() :3339
void View__Show_fn(View* __this)
{
    __this->Show();
}

// public static void Show(ObjC.Object handle) :3351
void View__Show1_fn(uObject* handle)
{
    View::Show1(handle);
}

// public virtual void set_Size(float2 value) :3330
...
// public virtual void set_Transform(float4x4 value) :3290
...
// protected View(ObjC.Object handle) [instance] :3263
...
// public void set_Background(Fuse.Drawing.Brush value) [instance] :3303
void View::Background(::g::Fuse::Drawing::Brush* value)
{
    ...
    if (value != NULL)
    {
        ...
        if ((sc == NULL) && (ssc == NULL))
            ::g::Fuse::Diagnostics::Unsupported(::g::Uno::Object::ToString(this), value, ::STRINGS[0/*"/usr/local/...*/], 3316, ::STRINGS[1/*"set_Backgro...*/]);
    }

    View::SetBackground(Handle(), c.X, c.Y, c.Z, c.W);
}

// public void BringToFront() [instance] :3365
...
// public void set_ClipToBounds(bool value) [instance] :3278
...
// public void Hide() [instance] :3344
void View::Hide()
{
...
// public void set_IsEnabled(bool value) [instance] :3389
...
// public void set_Opacity(float value) [instance] :3384
...
// internal Fuse.Controls.Native.iOS.ViewParent get_Parent() [instance] :3252
...
// internal void set_Parent(Fuse.Controls.Native.iOS.ViewParent value) [instance] :3253
...
// public void set_Position(float2 value) [instance] :3324
...
// public void Show() [instance] :3339
void View::Show()
{
...
// private static void BringToFront(ObjC.Object handle) [static] :3372
...
// public static void Hide(ObjC.Object handle) [static] :3359
...
// private static void SetAlpha(ObjC.Object handle, float a) [static] :3400
...
// public static void SetAnchorPoint(ObjC.Object handle) [static] :3270
...
// private static void SetBackground(ObjC.Object handle, float r, float g, float b, float a) [static] :3450
...
// public static void SetBounds(ObjC.Object handle, float x, float y, float w, float h) [static] :3417
...
// private static void SetClipToBounds(ObjC.Object handle, bool clipToBounds) [static] :3282
...
// private static void SetSize(ObjC.Object handle, float w, float h) [static] :3407
...
// public static void SetTransform(ObjC.Object handle, float m11, float m12, float m13, float m14, float m21, float m22, float m23, float m24, float m31, float m32, float m33, float m34, float m41, float m42, float m43, float m44) [static] :3433
...
// public static void SetTransform(ObjC.Object handle, float4x4 t) [static] :3423
...
// private static void SetUserInteractionEnabled(ObjC.Object handle, bool enabled) [static] :3393
...
// public static void Show(ObjC.Object handle) [static] :3351
