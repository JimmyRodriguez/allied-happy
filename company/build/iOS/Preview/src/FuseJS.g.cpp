...
// /usr/local/share/uno/Packages/FuseJS/0.35.8/$.uno
// -------------------------------------------------

// public sealed class Base64 :357
// {
...
// private object DecodeAscii(Fuse.Scripting.Context context, object[] args) :392
...
// private object DecodeUtf8(Fuse.Scripting.Context context, object[] args) :424
...
// private object EncodeAscii(Fuse.Scripting.Context context, object[] args) :376
...
// private object EncodeUtf8(Fuse.Scripting.Context context, object[] args) :408
...
// private object DecodeAscii(Fuse.Scripting.Context context, object[] args) [instance] :392
...
// private object DecodeUtf8(Fuse.Scripting.Context context, object[] args) [instance] :424
...
// private object EncodeAscii(Fuse.Scripting.Context context, object[] args) [instance] :376
...
// private object EncodeUtf8(Fuse.Scripting.Context context, object[] args) [instance] :408
...
// public sealed class Bundle :459
// {
...
// private static object Read(Fuse.Scripting.Context c, object[] args) [static] :529
...
// private static string Read(string filename) [static] :539
...
// private static Uno.Threading.Future<string> ReadAsync(object[] args) [static] :503
...
// private static Uno.Threading.Future<string> ReadAsync(string filename) [static] :556
...
// private static bool TryGetBundleFile(string sourcePath, Uno.IO.BundleFile& bundleFile) [static] :471
...
// public sealed class Environment :298
// {
...
// private static string GetMobileOSVersion() :314
...
// private static string GetMobileOSVersion() [static] :314
...
// private sealed class FileReaderImpl.FileReadCommand :592
// {
...
// public string ReadAsDataURL() :603
...
// public FileReadCommand(string path) [instance] :595
...
// public string ReadAsDataURL() [instance] :603
...
// public string ReadAsText() [instance] :599
...
// public FileReadCommand New(string path) [static] :595
...
// public sealed class FileReaderImpl :590
// {
...
// private static Uno.Threading.Future<string> readAsText(object[] args) :627
...
// public FileReaderImpl() [instance] :613
...
// public FileReaderImpl New() [static] :613
...
// private static Uno.Threading.Future<string> readAsDataURL(object[] args) [static] :621
...
// private static Uno.Threading.Future<string> readAsText(object[] args) [static] :627
...
// internal sealed class RaiseEvent :644
// {
static void RaiseEvent_build(uType* type)
{
    ::STRINGS[38] = uString::Const("Cannot find message with name: ");
    ::STRINGS[39] = uString::Const("/usr/local/share/uno/Packages/FuseJS/0.35.8/$.uno");
...
void RaiseEvent::Raise()
{
    ...
    if (dispatch == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[38/*"Cannot find...*/], Name), this, ::STRINGS[39/*"/usr/local/...*/], 656, ::STRINGS[40/*"Raise"*/]);
        return;
    }
...
// public generated RaiseEvent New() [static] :644
...
// private sealed class Bundle.ReadClosure :561
// {
...
// public ReadClosure(string filename) [instance] :565
...
// public string Invoke() [instance] :570
...
// public ReadClosure New(string filename) [static] :565
...
// public sealed class UserEvents :666
// {
...
// public UserEvents() :669
void UserEvents__ctor_2_fn(UserEvents* __this)
{
    __this->ctor_2();
}

// public UserEvents New() :669
void UserEvents__New2_fn(UserEvents** __retval)
{
    *__retval = UserEvents::New2();
}

// public static object Raise(Fuse.Scripting.Context context, object[] args) :682
...
// public UserEvents() [instance] :669
...
// public UserEvents New() [static] :669
...
// public static object Raise(Fuse.Scripting.Context context, object[] args) [static] :682
uObject* UserEvents::Raise(::g::Fuse::Scripting::Context* context, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::Deprecated(::STRINGS[43/*"The FuseJS/...*/], context, ::STRINGS[39/*"/usr/local/...*/], 687, ::STRINGS[40/*"Raise"*/]);
