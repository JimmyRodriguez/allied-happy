...
// /usr/local/share/uno/Packages/Fuse.Controls.Primitives/0.35.8/RangeControls/$.uno
// ---------------------------------------------------------------------------------
...
static void CircularRangeBehavior_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Primitives/0.35.8/RangeControls/$.uno");
...
// /usr/local/share/uno/Packages/Fuse.Gestures/0.35.8/$.uno
// --------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Gestures/0.35.8/Internal/$.uno
// -----------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls.ScrollView/0.35.8/$.uno
// -------------------------------------------------------------------
...
static void ScrollableGoto_build(uType* type)
{
    ...
    ::STRINGS[8] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.ScrollView/0.35.8/$.uno");
...
static void SwipeGesture_build(uType* type)
{
    ...
    ::STRINGS[15] = uString::Const("/usr/local/share/uno/Packages/Fuse.Gestures/0.35.8/$.uno");
    ::STRINGS[4] = uString::Const("OnRooted");
    ::TYPES[1] = ::g::Fuse::Elements::Element_typeof();
    type->SetInterfaces(
...
void SwipeGesture__OnRooted_fn(SwipeGesture* __this)
{
    ...
    if (element == NULL)
    {
        ::g::Fuse::Diagnostics::UserRootError(::STRINGS[14/*"Element"*/], __this->Parent(), __this, ::STRINGS[15/*"/usr/local/...*/], 903, ::STRINGS[4/*"OnRooted"*/]);
        return;
    }
