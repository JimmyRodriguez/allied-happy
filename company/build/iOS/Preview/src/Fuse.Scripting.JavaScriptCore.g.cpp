...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScriptCore/0.35.8/$.uno
// ------------------------------------------------------------------------
...
static void Context_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(5,
        ...
        new uFunction("Unwrap", NULL, (void*)Context__Unwrap1_fn, 0, false, ::g::Fuse::Scripting::JavaScriptCore::JSValueRef_typeof(), 1, uObject_typeof()),
        new uFunction("Unwrap", NULL, (void*)Context__Unwrap2_fn, 0, false, ::g::Fuse::Scripting::JavaScriptCore::JSValueRef_typeof()->Array(), 1, uObject_typeof()->Array()),
        new uFunction("Wrap", NULL, (void*)Context__Wrap1_fn, 0, false, uObject_typeof(), 1, ::g::Fuse::Scripting::JavaScriptCore::JSValueRef_typeof()),
        new uFunction("Wrap", NULL, (void*)Context__Wrap2_fn, 0, false, uObject_typeof()->Array(), 1, ::g::Fuse::Scripting::JavaScriptCore::JSValueRef_typeof()->Array()));
}
...
// public Fuse.Scripting.JavaScriptCore.JSValueRef Unwrap(object obj) :245
void Context__Unwrap1_fn(Context* __this, uObject* obj, ::JSValueRef* __retval)
{
    *__retval = __this->Unwrap1(obj);
}

// public Fuse.Scripting.JavaScriptCore.JSValueRef[] Unwrap(object[] obj) :271
...
// public object Wrap(Fuse.Scripting.JavaScriptCore.JSValueRef value) :210
void Context__Wrap1_fn(Context* __this, ::JSValueRef* value, uObject** __retval)
{
    *__retval = __this->Wrap1(*value);
}

// public object[] Wrap(Fuse.Scripting.JavaScriptCore.JSValueRef[] values) :235
...
// public Fuse.Scripting.JavaScriptCore.JSValueRef Unwrap(object obj) [instance] :245
...
// public Fuse.Scripting.JavaScriptCore.JSValueRef[] Unwrap(object[] obj) [instance] :271
...
// public object Wrap(Fuse.Scripting.JavaScriptCore.JSValueRef value) [instance] :210
...
// public object[] Wrap(Fuse.Scripting.JavaScriptCore.JSValueRef[] values) [instance] :235
...
static void JSValueRef_build(uType* type)
{
    ...
    ::STRINGS[21] = uString::Const("/usr/local/share/uno/Packages/Fuse.Scripting.JavaScriptCore/0.35.8/$.uno");
    ::TYPES[16] = uObject_typeof()->Array();
    ::TYPES[18] = ::g::Uno::IDisposable_typeof();
