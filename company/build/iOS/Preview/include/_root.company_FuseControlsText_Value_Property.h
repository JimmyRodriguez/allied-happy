...
namespace g{struct company_FuseControlsText_Value_Property;}
...
struct company_FuseControlsText_Value_Property : ::g::Uno::UX::Property1
{
    uWeak< ::g::Fuse::Controls::Text*> _obj;

    void ctor_2(::g::Fuse::Controls::Text* obj, ::g::Uno::UX::Selector name);
    static company_FuseControlsText_Value_Property* New1(::g::Fuse::Controls::Text* obj, ::g::Uno::UX::Selector name);
};
// }
