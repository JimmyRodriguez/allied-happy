...
// internal static extern class FontCache :379
// {
// static FontCache() :379
...
// private static iOS.CoreGraphics.CGFontRef CoreGraphicsFontRefFromPath(string path) :468
...
// public static iOS.UIKit.UIFont CreateFontFromName(string fontName, float fontSize) :458
...
// public static iOS.UIKit.UIFont GetDefaultFont(float fontSize) :463
void FontCache__GetDefaultFont_fn(float* fontSize, ::g::iOS::UIKit::UIFont** __retval)
{
    *__retval = FontCache::GetDefaultFont(*fontSize);
}

// public static iOS.UIKit.UIFont GetFontFromFile(Uno.UX.FileSource fileSource, float fontSize) :384
...
// private static iOS.UIKit.UIFont GetFromBundleFileSource(Uno.UX.BundleFileSource bundleFileSource, float fontSize) :392
...
// private static iOS.UIKit.UIFont GetFromFileSource(Uno.UX.FileSource fileSource, float fontSize) :415
...
// private static string GetPostScriptNameOfCGFontRef(iOS.CoreGraphics.CGFontRef font) :476
...
// private static bool RegisterFont(iOS.CoreGraphics.CGFontRef font) :442
...
// private static iOS.CoreGraphics.CGFontRef CoreGraphicsFontRefFromPath(string path) [static] :468
...
// public static iOS.UIKit.UIFont CreateFontFromName(string fontName, float fontSize) [static] :458
...
// public static iOS.UIKit.UIFont GetDefaultFont(float fontSize) [static] :463
...
// public static iOS.UIKit.UIFont GetFontFromFile(Uno.UX.FileSource fileSource, float fontSize) [static] :384
...
// private static iOS.UIKit.UIFont GetFromBundleFileSource(Uno.UX.BundleFileSource bundleFileSource, float fontSize) [static] :392
...
// private static iOS.UIKit.UIFont GetFromFileSource(Uno.UX.FileSource fileSource, float fontSize) [static] :415
...
// private static string GetPostScriptNameOfCGFontRef(iOS.CoreGraphics.CGFontRef font) [static] :476
...
// private static bool RegisterFont(iOS.CoreGraphics.CGFontRef font) [static] :442
