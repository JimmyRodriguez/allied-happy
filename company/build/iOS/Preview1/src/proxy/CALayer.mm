...
//{
//    uObjC_PROXY_FUNCTION_PROLOGUE
//    #{iOS.CoreGraphics.CGPoint} __return = #{iOS.QuartzCore.CALayer:Of(__this).anchorPoint():Call()};
//    return uObjC::Struct::FromUno_CGPoint(__return, ::CGPoint());
//}
//#endif // !IsStripped
...
//{
//    uObjC_PROXY_FUNCTION_PROLOGUE
//    #{iOS.QuartzCore.CALayer:Of(__this).setAnchorPoint(iOS.CoreGraphics.CGPoint):Call(uObjC::Struct::ToUno_CGPoint(anchorPoint, #{iOS.CoreGraphics.CGPoint}()))};
//}
//#endif // !IsStripped
...
//{
//    uObjC_PROXY_FUNCTION_PROLOGUE
//    #{iOS.QuartzCore.CATransform3D} __return = #{iOS.QuartzCore.CALayer:Of(__this).transform():Call()};
...
//{
//    uObjC_PROXY_FUNCTION_PROLOGUE
//    #{iOS.QuartzCore.CALayer:Of(__this).setTransform(iOS.QuartzCore.CATransform3D):Call(uObjC::Struct::ToUno_CATransform3D(transform, #{iOS.QuartzCore.CATransform3D}()))};
//}
//#endif // !IsStripped
