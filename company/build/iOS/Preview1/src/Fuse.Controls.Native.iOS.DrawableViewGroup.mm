...
// public DrawableViewGroup(Fuse.Visual visual) :141
...
// private static ObjC.Object Create() :269
void DrawableViewGroup__Create_fn(uObject** __retval)
{
    *__retval = DrawableViewGroup::Create();
}

// private static ObjC.Object CreateContainer() :286
...
// private void Fuse.Controls.Native.INativeViewRenderer.Draw(float4x4 localToClipTransform, float2 position, float2 size, float density) :161
...
// private void Fuse.Controls.Native.INativeViewRenderer.Invalidate() :172
...
// private void Fuse.Controls.Native.IOffscreenRenderer.DisableOffscreen() :188
...
// private void Fuse.Controls.Native.IOffscreenRenderer.EnableOffscreen() :178
...
// public DrawableViewGroup New(Fuse.Visual visual) :141
...
// private void OnSetFrame(ObjC.Object handle) :231
...
// private static void SetSetFrameCallback(ObjC.Object handle, Uno.Action<ObjC.Object> callback) :279
...
// private static void UpdateFrame(ObjC.Object sourceHandle, ObjC.Object targetHandle) :237
...
// public DrawableViewGroup(Fuse.Visual visual) [instance] :141
...
// private void OnSetFrame(ObjC.Object handle) [instance] :231
...
// private static ObjC.Object Create() [static] :269
...
// private static ObjC.Object CreateContainer() [static] :286
...
// public DrawableViewGroup New(Fuse.Visual visual) [static] :141
...
// private static void SetSetFrameCallback(ObjC.Object handle, Uno.Action<ObjC.Object> callback) [static] :279
...
// private static void UpdateFrame(ObjC.Object sourceHandle, ObjC.Object targetHandle) [static] :237
