...
// internal sealed extern class NativeViewRenderer :1371
// {
...
// public NativeViewRenderer(ObjC.Object viewHandle) :1378
void NativeViewRenderer__ctor__fn(NativeViewRenderer* __this, uObject* viewHandle)
{
    __this->ctor_(viewHandle);
}

// private void DeleteTexture() :1488
void NativeViewRenderer__DeleteTexture_fn(NativeViewRenderer* __this)
{
    __this->DeleteTexture();
}

// private static void Draw(ObjC.Object viewHandle, int textureName, Uno.IntPtr pixelBufferHandle, int width, int height, float density, bool reuse) :1425
...
// private static void FreePixelBuffer(Uno.IntPtr buffer) :1529
void NativeViewRenderer__FreePixelBuffer_fn(void** buffer)
{
    NativeViewRenderer::FreePixelBuffer(*buffer);
}

// private void Fuse.Controls.Native.INativeViewRenderer.Draw(float4x4 localToClipTransform, float2 position, float2 size, float density) :1384
...
// private void Fuse.Controls.Native.INativeViewRenderer.Invalidate() :1483
...
// private void Uno.IDisposable.Dispose() :1502
...
// public NativeViewRenderer(ObjC.Object viewHandle) [instance] :1378
...
// private void DeleteTexture() [instance] :1488
...
// private static void Draw(ObjC.Object viewHandle, int textureName, Uno.IntPtr pixelBufferHandle, int width, int height, float density, bool reuse) [static] :1425
...
// private static void FreePixelBuffer(Uno.IntPtr buffer) [static] :1529
...
// private static Uno.IntPtr MallocPixelBuffer(int size) [static] :1524
...
// public NativeViewRenderer New(ObjC.Object viewHandle) [static] :1378
