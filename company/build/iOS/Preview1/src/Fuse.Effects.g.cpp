...
// /usr/local/share/uno/Packages/Fuse.Effects/0.35.8/$.uno
// -------------------------------------------------------
...
void Blur::init_DrawCalls()
{
    ...
    _draw_7a2fdace = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall__New1(::g::FuseControls_bundle::Viewportccb5cb29());
}
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.35.8/Effects/$.uno
// ----------------------------------------------------------------
...
void EffectHelpers::init_DrawCalls()
{
    ...
    uArray* Indices_44444bad_2_3_1 = uArray::Init<int>(::TYPES[4/*ushort[]*/], 6, 0, 1, 2, 2, 3, 0);
