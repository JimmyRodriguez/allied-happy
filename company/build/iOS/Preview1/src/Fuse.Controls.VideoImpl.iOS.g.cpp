...
// /usr/local/share/uno/Packages/Fuse.Controls.Video/0.35.8/iOS/$.uno
// ------------------------------------------------------------------
...
// internal static extern class VideoPlayerImpl :108
// {
...
// public static extern void Pause(Uno.IntPtr videoState) :145
void VideoPlayerImpl__Pause_fn(void** videoState_)
{
    VideoPlayerImpl::Pause(*videoState_);
}

// public static extern void Play(Uno.IntPtr videoState) :142
void VideoPlayerImpl__Play_fn(void** videoState_)
{
    VideoPlayerImpl::Play(*videoState_);
}

// public static extern void SetErrorHandler(Uno.IntPtr videoState, Uno.Action errorHandler) :151
...
// public static extern void SetPosition(Uno.IntPtr videoState, double position) :127
void VideoPlayerImpl__SetPosition_fn(void** videoState_, double* position_)
{
    VideoPlayerImpl::SetPosition(*videoState_, *position_);
}

// public static extern void SetVolume(Uno.IntPtr videoState, float volume) :133
void VideoPlayerImpl__SetVolume_fn(void** videoState_, float* volume_)
{
    VideoPlayerImpl::SetVolume(*videoState_, *volume_);
}

// public static extern OpenGL.GLTextureHandle UpdateTexture(Uno.IntPtr videoState) :148
...
// public static extern Uno.IntPtr AllocateVideoState() [static] :112
...
// public static extern void FreeVideoState(Uno.IntPtr videoState) [static] :115
...
// public static extern double GetDuration(Uno.IntPtr videoState) [static] :121
...
// public static extern int GetHeight(Uno.IntPtr videoState) [static] :139
...
// public static extern double GetPosition(Uno.IntPtr videoState) [static] :124
...
// public static extern float GetVolume(Uno.IntPtr videoState) [static] :130
...
// public static extern int GetWidth(Uno.IntPtr videoState) [static] :136
...
// public static extern void Initialize(Uno.IntPtr videoState, string uri, Uno.Action loadedCallback, Uno.Action errorCallback) [static] :118
...
// public static extern void Pause(Uno.IntPtr videoState) [static] :145
...
// public static extern void Play(Uno.IntPtr videoState) [static] :142
...
// public static extern void SetErrorHandler(Uno.IntPtr videoState, Uno.Action errorHandler) [static] :151
...
// public static extern void SetPosition(Uno.IntPtr videoState, double position) [static] :127
...
// public static extern void SetVolume(Uno.IntPtr videoState, float volume) [static] :133
...
// public static extern OpenGL.GLTextureHandle UpdateTexture(Uno.IntPtr videoState) [static] :148
