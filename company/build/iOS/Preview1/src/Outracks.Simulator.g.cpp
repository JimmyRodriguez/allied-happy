...
static void Application_build(uType* type)
{
    ...
    ::STRINGS[9] = uString::Const("/usr/local/share/uno/Packages/Outracks.Simulator.Client.Uno/0.1.0/$.uno");
...
void Application__OnUpdate_fn(Application* __this)
{
    ...
    if (exception != NULL)
    {
        ...
        {
            ::g::Uno::Diagnostics::Debug::Log5(uPtr(exception)->Message(), 1, ::STRINGS[9/*"/usr/local/...*/], 269);
            ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[10/*"Failure sta...*/], 1, ::STRINGS[9/*"/usr/local/...*/], 270);
        }
        else
        {
...
void Application::ResetEverything(bool initial)
{
    ...
    catch (const uThrowable& __t)
    {
        ...
        ::g::Fuse::Diagnostics::UnknownException(::STRINGS[11/*"Failed to p...*/], e, this, ::STRINGS[9/*"/usr/local/...*/], 176, ::STRINGS[12/*"ResetEveryt...*/]);
    }
...
// public static extern class DeviceInfo :1734
// {
...
// public static string get_Name() [static] :1738
...
void Running__OnUpdate_fn(Running* __this, ::g::Outracks::Simulator::State** __retval)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[59/*"Density cha...*/], 1, ::STRINGS[9/*"/usr/local/...*/], 634);
...
void ShowingModalDialog__OnException_fn(ShowingModalDialog* __this, ::g::Uno::Exception* e, ::g::Outracks::Simulator::State** __retval)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(uPtr(e)->Message(), 1, ::STRINGS[9/*"/usr/local/...*/], 1612);
    return *__retval = __this, void();
}
...
void ShowingPrompt__OnEnterState_fn(ShowingPrompt* __this, ::g::Outracks::Simulator::State** __retval)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition2(::STRINGS[62/*"# "*/], __this->_header), 1, ::STRINGS[9/*"/usr/local/...*/], 1522);
    ::g::Uno::Diagnostics::Debug::Log5(__this->_body, 1, ::STRINGS[9/*"/usr/local/...*/], 1523);
...
void SimulatorClient::Dispose()
{
    ...
    {
        ::g::Uno::Exception* e = __t.Exception;
        ::g::Uno::Diagnostics::Debug::Log5(uPtr(e)->Message(), 1, ::STRINGS[9/*"/usr/local/...*/], 1118);
    }
}
