...
// C:\ProgramData\Uno\Packages\Fuse.Controls.Native\0.32.14\iOS\$.uno
// ------------------------------------------------------------------
...
// public sealed extern class Slider :1808
// {
...
// public Slider(Fuse.Controls.Native.IRangeViewHost host) :1813
void Slider__ctor__fn(Slider* __this, uObject* host)
{
    __this->ctor_(host);
}

// public Slider New(Fuse.Controls.Native.IRangeViewHost host) :1813
void Slider__New1_fn(uObject* host, Slider** __retval)
{
    *__retval = Slider::New1(host);
}

// public void set_Progress(double value) :1810
void Slider__set_Progress_fn(Slider* __this, double* value)
{
    __this->Progress(*value);
}

// public Slider(Fuse.Controls.Native.IRangeViewHost host) [instance] :1813
void Slider::ctor_(uObject* host)
{
}

// public void set_Progress(double value) [instance] :1810
void Slider::Progress(double value)
{
}

// public Slider New(Fuse.Controls.Native.IRangeViewHost host) [static] :1813
...
// public void set_Host(Fuse.Controls.Native.IToggleViewHost value) :1891
...
// public void set_Host(Fuse.Controls.Native.IToggleViewHost value) [instance] :1891
