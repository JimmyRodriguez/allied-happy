...
// C:\ProgramData\Uno\Packages\Fuse.Scripting\0.32.14\$.uno
// --------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\FuseCore\0.32.14\Scripting\$.uno
// ------------------------------------------------------------
...
static void Context_build(uType* type)
{
    ...
    ::STRINGS[9] = uString::Const("Object.create");
...
// public Fuse.Scripting.Object ObjectCreate(object[] args) :650
...
::g::Fuse::Scripting::Array* Context::NewArray(uArray* values)
{
    ...
    ::g::Fuse::Scripting::Array* a = uCast< ::g::Fuse::Scripting::Array*>(Evaluate(::STRINGS[5/*"(no file)"*/], ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[6/*"new Array("*/], uBox<int>(::TYPES[24/*int*/], uPtr(values)->Length())), ::STRINGS[7/*")"*/])), ::TYPES[7/*Fuse.Scripting.Array*/]);
...
// public Fuse.Scripting.Object ObjectCreate(object[] args) [instance] :650
::g::Fuse::Scripting::Object* Context::ObjectCreate(uArray* args)
{
    uStackFrame __("Fuse.Scripting.Context", "ObjectCreate(object[])");
    ::g::Fuse::Scripting::Function* objectCreate = uAs< ::g::Fuse::Scripting::Function*>(Evaluate(::STRINGS[5/*"(no file)"*/], ::STRINGS[9/*"Object.create"*/]), ::TYPES[5/*Fuse.Scripting.Function*/]);
...
void Context::ObjectDefineProperty(::g::Fuse::Scripting::Object* obj, uString* name, uDelegate* getProperty, uDelegate* setProperty, bool enumerable, bool configurable)
{
    ...
    ::g::Fuse::Scripting::Function* func = uAs< ::g::Fuse::Scripting::Function*>(Evaluate(::STRINGS[3/*""*/], ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[10/*"(function(o...*/], ::g::Uno::Delegate::op_Inequality(setProperty, NULL) ? ::STRINGS[11/*" set: setCa...*/] : ::STRINGS[3/*""*/]), ::STRINGS[12/*" enumerable...*/])), ::TYPES[5/*Fuse.Scripting.Function*/]);
    uPtr(func)->Call(uArray::Init<uObject*>(::TYPES[6/*object[]*/], 6, obj, name, getProperty, setProperty, uBox(::TYPES[25/*bool*/], enumerable), uBox(::TYPES[25/*bool*/], configurable)));
}
...
void Context::ObjectDefineProperty1(::g::Fuse::Scripting::Object* obj, uString* name, uObject* value, bool enumerable, bool configurable)
{
    ...
    ::g::Fuse::Scripting::Function* func = uAs< ::g::Fuse::Scripting::Function*>(Evaluate(::STRINGS[3/*""*/], ::STRINGS[13/*"(function(o...*/]), ::TYPES[5/*Fuse.Scripting.Function*/]);
    uPtr(func)->Call(uArray::Init<uObject*>(::TYPES[6/*object[]*/], 5, obj, name, value, uBox(::TYPES[25/*bool*/], enumerable), uBox(::TYPES[25/*bool*/], configurable)));
}
...
uObject* Context::ParseJson(uString* json)
{
    ...
    if (_parseJson == NULL)
        _parseJson = uCast< ::g::Fuse::Scripting::Function*>(Evaluate(::STRINGS[5/*"(no file)"*/], ::STRINGS[14/*"JSON.parse"*/]), ::TYPES[5/*Fuse.Scripting.Function*/]);
...
uObject* NativePromise__ContextClosure::CreatePromise(uArray* args)
{
    ...
    ::g::Fuse::Scripting::Function* promise = uCast< ::g::Fuse::Scripting::Function*>(uPtr(uPtr(_c)->GlobalObject())->Item(::STRINGS[15/*"Promise"*/]), ::TYPES[5/*Fuse.Scripting.Function*/]);
...
{
    ::STRINGS[5] = uString::Const("(no file)");
    ::STRINGS[16] = uString::Const("Object.freeze");
    ::STRINGS[17] = uString::Const("Property '");
    ::STRINGS[18] = uString::Const("' does not exist on object");
    ::TYPES[5] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[6] = uObject_typeof()->Array();
    ::TYPES[1] = uObject_typeof();
...
// public static void Freeze(Fuse.Scripting.Object ob, Fuse.Scripting.Context c) :1291
void JSObjectUtils__Freeze_fn(::g::Fuse::Scripting::Object* ob, ::g::Fuse::Scripting::Context* c)
{
    JSObjectUtils::Freeze(ob, c);
}

// public static T Value<T>(Fuse.Scripting.Object obj, string name) :1279
void JSObjectUtils__Value_fn(uType* __type, ::g::Fuse::Scripting::Object* obj, uString* name, uTRef __retval)
{
    ...
    if (v == NULL)
        U_THROW(::g::Uno::ArgumentException::New4(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[17/*"Property '"*/], name), ::STRINGS[18/*"' does not ...*/])));

    return __retval.Store((::g::Fuse::Scripting::Marshal__ToType_fn(__types[1], v, &ret1), ret1)), void();
}

// public static T Value<T>(object[] args, int index) :1286
...
// public static T ValueOrDefault<T>(object[] args, int index, [T defaultValue]) :1273
...
// public static void Freeze(Fuse.Scripting.Object ob, Fuse.Scripting.Context c) [static] :1291
void JSObjectUtils::Freeze(::g::Fuse::Scripting::Object* ob, ::g::Fuse::Scripting::Context* c)
{
    ...
    ::g::Fuse::Scripting::Function* freeze = uCast< ::g::Fuse::Scripting::Function*>(uPtr(c)->Evaluate(::STRINGS[5/*"(no file)"*/], ::STRINGS[16/*"Object.freeze"*/]), ::TYPES[5/*Fuse.Scripting.Function*/]);
    uPtr(freeze)->Call(uArray::Init<uObject*>(::TYPES[6/*object[]*/], 1, ob));
}
// }
...
static void Json_build(uType* type)
{
    ...
    ::STRINGS[21] = uString::Const("Json.Stringify(): object can not contain cycles");
    ...
    ::STRINGS[28] = uString::Const("null");
    ::STRINGS[29] = uString::Const("true");
    ::STRINGS[30] = uString::Const("false");
...
// public static string Escape(string s) :508
...
// public static string ToLiteral(string s) :539
...
// public static string Escape(string s) [static] :508
...
void Json::Stringify1(uObject* value, bool normalized, ::g::Uno::Text::StringBuilder* sb, ::g::Uno::Collections::HashSet* visitedSet)
{
    ...
    else if (uIs(value, ::TYPES[8/*Fuse.Scripting.Object*/]))
    {
        if ((::g::Uno::Collections::HashSet__Contains_fn(uPtr(visitedSet), value, &ret1), ret1))
            U_THROW(::g::Uno::Exception::New2(::STRINGS[21/*"Json.String...*/]));
    ...
    else if (uIs(value, ::TYPES[7/*Fuse.Scripting.Array*/]))
    {
        ...
        uPtr(sb)->Append2(::STRINGS[28/*"null"*/]);
}
...
uString* Json::ToLiteral(bool b)
{
    ...
    if (b)
        return ::STRINGS[29/*"true"*/];
    else
        return ::STRINGS[30/*"false"*/];
}
...
// public static string ToLiteral(string s) [static] :539
uString* Json::ToLiteral2(uString* s)
{
    uStackFrame __("Fuse.Scripting.Json", "ToLiteral(string)");
    return ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[31/*"\""*/], Json::Escape(s)), ::STRINGS[31/*"\""*/]);
}
...
{
    ::STRINGS[32] = uString::Const("Unable to convert ");
    ::STRINGS[33] = uString::Const(" to bool");
    ::STRINGS[34] = uString::Const("Expected number was ");
    ::STRINGS[35] = uString::Const("C:\\ProgramData\\Uno\\Packages\\Fuse.Scripting\\0.32.14\\$.uno");
    ::STRINGS[36] = uString::Const("path");
    ::STRINGS[37] = uString::Const(" to a FileSource");
    ::STRINGS[38] = uString::Const("#");
    ::STRINGS[39] = uString::Const(" to float4");
    ::STRINGS[40] = uString::Const("Unable to parse selector value: ");
    ::STRINGS[41] = uString::Const("%");
    ::STRINGS[42] = uString::Const("px");
    ::STRINGS[43] = uString::Const("pt");
    ::STRINGS[44] = uString::Const("Unable to parse size value: ");
    ::STRINGS[45] = uString::Const("Unable to parse size vector: ");
    ::STRINGS[46] = uString::Const("Unable to convert '");
    ::STRINGS[47] = uString::Const("' to type ");
    ...
    ::TYPES[36] = ::g::Fuse::Scripting::IObject_typeof();
    ::TYPES[37] = ::g::Fuse::Scripting::IArray_typeof();
...
void Marshal__ToType_fn(uType* __type, uObject* o, uTRef __retval)
{
    ...
    if ((Marshal__TryConvertTo1_fn(__types[1], o, &value, &ret5), ret5))
        ...
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[46/*"Unable to c...*/], o), ::STRINGS[47/*"' to type "*/]), __types[0])));
}
...
bool Marshal::ToBool(uObject* obj)
{
    ...
    if (uIs(obj, ::TYPES[25/*bool*/]))
        ...
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[32/*"Unable to c...*/], obj), ::STRINGS[33/*" to bool"*/])));
}
...
double Marshal::ToDouble(uObject* o)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition1(::STRINGS[34/*"Expected nu...*/], ::g::Uno::Object::GetType(uPtr(o))), 1, ::STRINGS[35/*"C:\\Program...*/], 392);
        return 0.0;
    }
}
...
::g::Uno::UX::FileSource* Marshal::ToFileSource(uObject* obj)
{
    ...
    else if (uIs(obj, ::TYPES[36/*Fuse.Scripting.IObject*/]))
        return ::g::Fuse::Scripting::JSFileSource::New1(uAs<uString*>(::g::Fuse::Scripting::IObject::Item(uInterface(uPtr((uObject*)obj), ::TYPES[36/*Fuse.Scripting.IObject*/]), ::STRINGS[36/*"path"*/]), ::TYPES[21/*string*/]));
    else
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[32/*"Unable to c...*/], ::g::Uno::Object::GetType(uPtr(obj))), ::STRINGS[37/*" to a FileS...*/])));
}
...
::g::Uno::Float4 Marshal::ToFloat4(uObject* values)
{
    ...
    Marshal_typeof()->Init();
    float r = (::g::Fuse::Scripting::IArray::Length(uInterface(uPtr(values), ::TYPES[37/*Fuse.Scripting.IArray*/])) > 0) ? Marshal::ToFloat(::g::Fuse::Scripting::IArray::Item(uInterface(uPtr(values), ::TYPES[37/*Fuse.Scripting.IArray*/]), 0)) : 0.0f;
    float g = (::g::Fuse::Scripting::IArray::Length(uInterface(values, ::TYPES[37/*Fuse.Scripting.IArray*/])) > 1) ? Marshal::ToFloat(::g::Fuse::Scripting::IArray::Item(uInterface(values, ::TYPES[37/*Fuse.Scripting.IArray*/]), 1)) : r;
    float b = (::g::Fuse::Scripting::IArray::Length(uInterface(values, ::TYPES[37/*Fuse.Scripting.IArray*/])) > 2) ? Marshal::ToFloat(::g::Fuse::Scripting::IArray::Item(uInterface(values, ::TYPES[37/*Fuse.Scripting.IArray*/]), 2)) : r;
    float a = (::g::Fuse::Scripting::IArray::Length(uInterface(values, ::TYPES[37/*Fuse.Scripting.IArray*/])) > 3) ? Marshal::ToFloat(::g::Fuse::Scripting::IArray::Item(uInterface(values, ::TYPES[37/*Fuse.Scripting.IArray*/]), 3)) : 1.0f;
...
::g::Uno::Float4 Marshal::ToFloat41(uObject* o)
{
    ...
    Marshal_typeof()->Init();
    uObject* aa = uAs<uObject*>(o, ::TYPES[37/*Fuse.Scripting.IArray*/]);
    ...
    if (uIs(o, ::TYPES[21/*string*/]))
    {
        ...
        if (::g::Uno::String::StartsWith(uPtr(s), ::STRINGS[38/*"#"*/]))
            return ::g::Uno::Color::FromHex(s);
    }

    U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[32/*"Unable to c...*/], o), ::STRINGS[39/*" to float4"*/])));
}
...
::g::Uno::UX::Selector Marshal::ToSelector(uObject* o)
{
    ...
    if (uIs(o, ::TYPES[38/*Uno.UX.Selector*/]))
        return uUnbox< ::g::Uno::UX::Selector>(::TYPES[38/*Uno.UX.Selector*/], o);
    else if (uIs(o, ::TYPES[21/*string*/]))
...
::g::Uno::UX::Size Marshal::ToSize(uObject* o)
{
    ...
    U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition1(::STRINGS[44/*"Unable to p...*/], o)));
}
...
::g::Uno::UX::Size2 Marshal::ToSize2(uObject* o)
{
    ...
    if (uIs(o, ::TYPES[37/*Fuse.Scripting.IArray*/]))
    {
        uObject* a = (uObject*)o;
        return ::g::Uno::UX::Size2__New1(Marshal::ToSize(::g::Fuse::Scripting::IArray::Item(uInterface(uPtr(a), ::TYPES[37/*Fuse.Scripting.IArray*/]), 0)), Marshal::ToSize(::g::Fuse::Scripting::IArray::Item(uInterface(uPtr(a), ::TYPES[37/*Fuse.Scripting.IArray*/]), 1)));
    }

    U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition1(::STRINGS[45/*"Unable to p...*/], o)));
}
...
uObject* Marshal::TryConvertTo(uType* t, uObject* o)
{
    ...
    if (o == NULL)
    ...
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[38/*Uno.UX.Selector*/]))
        return uBox(::TYPES[38/*Uno.UX.Selector*/], Marshal::ToSelector(o));
        ...
        return uBox(::TYPES[39/*Uno.UX.Size*/], Marshal::ToSize(o));
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[40/*Uno.UX.Size2*/]))
        return uBox(::TYPES[40/*Uno.UX.Size2*/], Marshal::ToSize2(o));
...
static void Module_build(uType* type)
{
    ...
    ::STRINGS[49] = uString::Const("id");
    ::TYPES[1] = uObject_typeof();
    ::TYPES[42] = ::g::Fuse::Scripting::ScriptException_typeof();
    type->SetInterfaces(
...
::g::Fuse::Scripting::ModuleResult* Module::Evaluate1(::g::Fuse::Scripting::Context* c, uString* id)
{
    ...
    uPtr(module)->Item(::STRINGS[48/*"exports"*/], c->NewObject());
    ...
    {
        if (uIs(__t.Exception, ::TYPES[42/*Fuse.Scripting.ScriptException*/]))
        {
    ...
    if (::g::Uno::String::op_Inequality(id, NULL))
        uPtr(module)->Item(::STRINGS[49/*"id"*/], id);
...
uObject* Module::EvaluateExports(::g::Fuse::Scripting::Context* c, uString* id)
{
    ...
    uObject* r = uPtr(uPtr(Evaluate1(c, id))->Object)->Item(::STRINGS[48/*"exports"*/]);
    return r;
}
// }
...
{
    ::STRINGS[50] = uString::Const("(unknown module)");
    ::STRINGS[48] = uString::Const("exports");
    ::TYPES[43] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Action_typeof());
    ::TYPES[44] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[45] = ::g::Uno::EventHandler1_typeof()->MakeType(::g::Uno::EventArgs_typeof());
    type->SetFields(0,
...
void ModuleResult__ToString_fn(ModuleResult* __this, uString** __retval)
{
    ...
    return *__retval = ::STRINGS[50/*"(unknown mo...*/], void();
}
...
uObject* ModuleResult::Exports()
{
    ...
    return uPtr(Object)->Item(::STRINGS[48/*"exports"*/]);
}
...
{
    ::TYPES[46] = ::g::Uno::Collections::Queue_typeof()->MakeType(uObject_typeof()->Array());
    ::TYPES[47] = ::g::Uno::Threading::IDispatcherExtensions_typeof()->MakeMethod(2, uObject_typeof()->Array(), uObject_typeof());
    ::TYPES[48] = ::g::Uno::Func1_typeof()->MakeType(uObject_typeof()->Array(), uObject_typeof());
    type->SetFields(8,
...
{
    ::STRINGS[51] = uString::Const("NativeModule(): Cannot add more members after first use");
    ::STRINGS[48] = uString::Const("exports");
    ::TYPES[49] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Scripting::NativeMember_typeof());
    ::TYPES[8] = ::g::Fuse::Scripting::Object_typeof();
    ::TYPES[50] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Fuse::Scripting::NativeMember_typeof());
    ::TYPES[9] = ::g::Uno::Delegate_typeof();
    ::TYPES[51] = ::g::Fuse::Scripting::Module_typeof();
...
void NativeModule__Evaluate_fn(NativeModule* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result)
{
    ...
    ::g::Fuse::Scripting::Object* obj = uAs< ::g::Fuse::Scripting::Object*>(uPtr(module)->Item(::STRINGS[48/*"exports"*/]), ::TYPES[8/*Fuse.Scripting.Object*/]);

    for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Scripting::NativeMember*> > enum1 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(__this->_members), &ret3), ret3); enum1.MoveNext(::TYPES[50/*Uno.Collections.List<Fuse.Scripting.NativeMember>.Enumerator*/]); )
    {
...
void NativeModule::AddMember(::g::Fuse::Scripting::NativeMember* member)
{
    ...
    if (_isEvaluated)
        U_THROW(::g::Uno::Exception::New2(::STRINGS[51/*"NativeModul...*/]));
...
void NativeModule::add_Evaluated(uDelegate* value)
{
    ...
    if (_isEvaluated)
        ...
        _evaluated = uCast<uDelegate*>(::g::Uno::Delegate::Combine(_evaluated, value), ::TYPES[52/*Uno.EventHandler*/]);
}
...
void NativeModule::remove_Evaluated(uDelegate* value)
{
    ...
    _evaluated = uCast<uDelegate*>(::g::Uno::Delegate::Remove(_evaluated, value), ::TYPES[52/*Uno.EventHandler*/]);
}
...
void NativeModule::add_Reset(uDelegate* value)
{
    ...
    _reset = uCast<uDelegate*>(::g::Uno::Delegate::Combine(_reset, value), ::TYPES[52/*Uno.EventHandler*/]);
}
...
void NativeModule::remove_Reset(uDelegate* value)
{
    ...
    _reset = uCast<uDelegate*>(::g::Uno::Delegate::Remove(_reset, value), ::TYPES[52/*Uno.EventHandler*/]);
}
...
{
    ::TYPES[53] = ::g::Fuse::Scripting::FutureFactory_typeof();
    ::TYPES[1] = uObject_typeof();
    ::TYPES[10] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[54] = NativePromise__ContextClosure_typeof();
    ::TYPES[55] = ::g::Uno::Threading::Promise_typeof();
    ::TYPES[56] = ::g::Uno::Action_typeof();
    ::TYPES[57] = ::g::Fuse::Scripting::FactoryClosure_typeof();
    ::TYPES[58] = ::g::Uno::Threading::Future1_typeof();
    type->SetPrecalc(
...
::g::Uno::Threading::Future1* NativePromise::Factory(uArray* args)
{
    ...
    uPtr(::g::Uno::Threading::Thread::Create(uDelegate::New(::TYPES[56/*Uno.Action*/], (void*)::g::Fuse::Scripting::FactoryClosure__Run_fn, (::g::Fuse::Scripting::FactoryClosure*)::g::Fuse::Scripting::FactoryClosure::New1(__types[2], _func, args, future))))->Start();
    return future;
}
...
static void NativeProperty_build(uType* type)
{
    ...
    ::TYPES[10] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[9] = ::g::Uno::Delegate_typeof();
    ::TYPES[59] = ::g::Uno::Func_typeof();
    ::TYPES[60] = ::g::Uno::Action1_typeof();
    type->SetPrecalc(
...
static void JSCallback__NumberConverter_build(uType* type)
{
    ::TYPES[2] = ::g::Uno::Type_typeof();
    ::TYPES[1] = uObject_typeof();
    ::TYPES[61] = ::g::Uno::Short_typeof();
    ::TYPES[24] = ::g::Uno::Int_typeof();
    ::TYPES[62] = ::g::Uno::Long_typeof();
    ::TYPES[23] = ::g::Uno::Float_typeof();
    ::TYPES[22] = ::g::Uno::Double_typeof();
    ::TYPES[12] = ::g::Uno::Exception_typeof();
    type->Reflection.SetFunctions(3,
...
uObject* JSCallback__NumberConverter::Convert(double value, uType* targetType)
{
    ...
    if (::g::Uno::Type::op_Equality(targetType, ::TYPES[61/*short*/]))
        return uBox<int16_t>(::TYPES[61/*short*/], (int16_t)value);

    if (::g::Uno::Type::op_Equality(targetType, ::TYPES[24/*int*/]))
        return uBox<int>(::TYPES[24/*int*/], (int)value);

    if (::g::Uno::Type::op_Equality(targetType, ::TYPES[62/*long*/]))
        return uBox<int64_t>(::TYPES[62/*long*/], (int64_t)value);
...
uObject* JSCallback__NumberConverter::Convert3(int64_t value, uType* targetType)
{
    ...
    return uBox<int64_t>(::TYPES[62/*long*/], value);
}
...
uObject* JSCallback__NumberConverter::Convert4(int16_t value, uType* targetType)
{
    ...
    return uBox<int16_t>(::TYPES[61/*short*/], value);
}
...
uObject* JSCallback__NumberConverter::Convert5(uType* targetType, uObject* value)
{
    ...
    if (uIs(value, ::TYPES[61/*short*/]))
        return JSCallback__NumberConverter::Convert4(uUnbox<int16_t>(::TYPES[61/*short*/], value), targetType);

    if (uIs(value, ::TYPES[24/*int*/]))
        return JSCallback__NumberConverter::Convert2(uUnbox<int>(::TYPES[24/*int*/], value), targetType);

    if (uIs(value, ::TYPES[62/*long*/]))
        return JSCallback__NumberConverter::Convert3(uUnbox<int64_t>(::TYPES[62/*long*/], value), targetType);
...
static void NativePromise__PromiseClosure_build(uType* type)
{
    ...
    ::TYPES[5] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[60] = ::g::Uno::Action1_typeof();
    ::TYPES[64] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::Exception_typeof());
    type->SetPrecalc(
...
void NativePromise__PromiseClosure__Resolve_fn(NativePromise__PromiseClosure* __this, void* result)
{
    ...
    if (__this->_resolve != NULL)
        ::g::Uno::Threading::IDispatcher::Invoke(uInterface(uPtr(uPtr(__this->_c)->Dispatcher), ::TYPES[63/*Uno.Threading.IDispatcher*/]), uDelegate::New(::TYPES[56/*Uno.Action*/], (void*)NativePromise__PromiseClosure__InternalResolve_fn, __this));
}
...
void NativePromise__PromiseClosure::Reject(::g::Uno::Exception* reason)
{
    ...
    if (_reject != NULL)
        ::g::Uno::Threading::IDispatcher::Invoke(uInterface(uPtr(uPtr(_c)->Dispatcher), ::TYPES[63/*Uno.Threading.IDispatcher*/]), uDelegate::New(::TYPES[56/*Uno.Action*/], (void*)NativePromise__PromiseClosure__InternalReject_fn, this));
}
...
uObject* NativePromise__PromiseClosure::Run(uArray* args)
{
    ...
    uPtr(_promise)->Then1(uDelegate::New(__types[0], (void*)NativePromise__PromiseClosure__Resolve_fn, this), uDelegate::New(::TYPES[64/*Uno.Action<Uno.Exception>*/], (void*)NativePromise__PromiseClosure__Reject_fn, this));
    return NULL;
}
...
{
    ::STRINGS[52] = uString::Const("require(): accepts exactly one argument, ");
    ::STRINGS[53] = uString::Const(" provided");
    ::STRINGS[54] = uString::Const("require(): argument must be a string");
    ::STRINGS[55] = uString::Const("require(): module not found: ");
    ::STRINGS[56] = uString::Const("JavaScript error in ");
    ::STRINGS[57] = uString::Const(" was fixed!");
    ::STRINGS[35] = uString::Const("C:\\ProgramData\\Uno\\Packages\\Fuse.Scripting\\0.32.14\\$.uno");
    ::STRINGS[58] = uString::Const("Require");
    ::STRINGS[59] = uString::Const(" line ");
...
uObject* ScriptModule__RequireContext::Require(uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
        U_THROW(::g::Fuse::Scripting::Error::New4(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[52/*"require(): ...*/], uBox<int>(::TYPES[24/*int*/], uPtr(args)->Length())), ::STRINGS[53/*" provided"*/])));

    uString* id = uAs<uString*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[21/*string*/]);

    if (::g::Uno::String::op_Equality(id, NULL))
        U_THROW(::g::Fuse::Scripting::Error::New4(::STRINGS[54/*"require(): ...*/]));
...
uObject* ScriptModule__RequireContext::Require1(uString* id)
{
    ...
    if (module == NULL)
    {
        ...
        if (mod == NULL)
            U_THROW(::g::Fuse::Scripting::Error::New4(::g::Uno::String::op_Addition2(::STRINGS[55/*"require(): ...*/], id)));

        module = uPtr(mod)->Evaluate1(_c, path);
        uPtr(module)->AddDependency(uDelegate::New(::TYPES[56/*Uno.Action*/], (void*)::g::Fuse::Scripting::ModuleResult__Invalidate_fn, uPtr(_dependant)));

        if (module->Error() == NULL)
        {
            if (::g::Uno::String::op_Equality(ScriptModule__RequireContext::_lastErrorPath_, path))
            {
                ::g::Fuse::Diagnostics::UserSuccess(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[56/*"JavaScript ...*/], path), ::STRINGS[57/*" was fixed!"*/]), this, ::STRINGS[35/*"C:\\Program...*/], 204, ::STRINGS[58/*"Require"*/]);
        ...
        else
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[56/*"JavaScript ...*/], path), ::STRINGS[59/*" line "*/]), uBox<int>(::TYPES[24/*int*/], uPtr(e)->LineNumber())), ::STRINGS[60/*". "*/]), uPtr(e)->ErrorMessage()), this, ::STRINGS[35/*"C:\\Program...*/], 214, ::STRINGS[58/*"Require"*/]);
    ...
    return uPtr(uPtr(module)->Object)->Item(::STRINGS[48/*"exports"*/]);
}
...
{
    ::TYPES[65] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::Type_typeof(), ScriptClass_typeof());
    type->SetFields(0,
...
static void ScriptException_build(uType* type)
{
    ...
    ::STRINGS[62] = uString::Const("Error message: ");
    ::STRINGS[63] = uString::Const("File name: ");
    ::STRINGS[64] = uString::Const("Line number: ");
    ::STRINGS[65] = uString::Const("Source line: ");
    ::STRINGS[66] = uString::Const("JS stack trace: ");
    ::TYPES[24] = ::g::Uno::Int_typeof();
    type->SetFields(3,
...
void ScriptException__get_Message_fn(ScriptException* __this, uString** __retval)
{
    ...
    {
        uPtr(stringBuilder)->Append2(::STRINGS[65/*"Source line: "*/]);
        stringBuilder->AppendLine(__this->SourceLine());
    }

    if (!::g::Uno::String::IsNullOrEmpty(__this->JSStackTrace()))
    {
        uPtr(stringBuilder)->Append2(::STRINGS[66/*"JS stack tr...*/]);
...
{
    ::STRINGS[67] = uString::Const("Cannot call a non-void method asynchronously");
    ::STRINGS[68] = uString::Const("C:\\ProgramData\\Uno\\Packages\\FuseCore\\0.32.14\\Scripting\\$.uno");
    ::STRINGS[69] = uString::Const("Call");
    ::TYPES[24] = ::g::Uno::Int_typeof();
    ::TYPES[9] = ::g::Uno::Delegate_typeof();
    ::TYPES[1] = uObject_typeof();
    ::TYPES[56] = ::g::Uno::Action_typeof();
    ::TYPES[66] = ScriptMethod1__CallClosure_typeof();
    type->SetPrecalc(
...
void ScriptMethod1__Call_fn(ScriptMethod1* __this, uObject* obj, uArray* args, uObject** __retval)
{
    ...
    if (__this->Thread == 2)
    {
        ...
        {
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[67/*"Cannot call...*/], __this, ::STRINGS[68/*"C:\\Program...*/], 129, ::STRINGS[69/*"Call"*/]);
            return *__retval = NULL, void();
        }

        ::g::Fuse::UpdateManager::PostAction(uDelegate::New(::TYPES[56/*Uno.Action*/], (void*)ScriptMethod1__CallClosure__Run_fn, ScriptMethod1__CallClosure::New1(__types[0], __this->_voidMethod, obj, args)));
        return *__retval = NULL, void();
    }
...
{
    ScriptModule::ModuleContainsAnErrorMessage_ = ::STRINGS[70/*"require(): ...*/];
}

static void ScriptModule_build(uType* type)
{
    ::STRINGS[70] = uString::Const("require(): module contains an error: ");
    ::STRINGS[71] = uString::Const(".");
    ::STRINGS[72] = uString::Const("/");
    ::STRINGS[3] = uString::Const("");
    ::STRINGS[73] = uString::Const("..");
    ::STRINGS[74] = uString::Const("(function(");
    ::STRINGS[75] = uString::Const(") { ");
    ::STRINGS[76] = uString::Const("\n"
        " })");
    ::STRINGS[77] = uString::Const("Could not evaluate module '");
    ::STRINGS[78] = uString::Const("': JavaScript code contains errors");
    ::STRINGS[48] = uString::Const("exports");
    ::STRINGS[79] = uString::Const("module, exports, require");
    ::STRINGS[80] = uString::Const(".js");
    ::TYPES[67] = ::g::Fuse::Scripting::IModuleProvider_typeof();
    ::TYPES[41] = ::g::Uno::Char_typeof()->Array();
    ...
    ::TYPES[51] = ::g::Fuse::Scripting::Module_typeof();
    ::TYPES[35] = ::g::Uno::UX::FileSource_typeof();
    ::TYPES[69] = ::g::Uno::Predicate_typeof()->MakeType(uObject_typeof());
    ::TYPES[70] = ::g::Uno::UX::BundleFileSource_typeof();
    type->SetInterfaces(
...
void ScriptModule__Evaluate_fn(ScriptModule* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result)
{
    ...
    ::g::Uno::Collections::List* args = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[68/*Uno.Collections.List<object>*/]);
    uString* wrappedCode = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[74/*"(function("*/], __this->GenerateArgs(c, result, args)), ::STRINGS[75/*") { "*/]), uString::CharArray(newlines)), __this->Code()), ::STRINGS[76/*"\n })"*/]);
    ...
    if (moduleFunc == NULL)
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[77/*"Could not e...*/], __this->FileName()), ::STRINGS[78/*"': JavaScri...*/])));
...
void ScriptModule__GenerateArgs_fn(ScriptModule* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result, ::g::Uno::Collections::List* args, uString** __retval)
{
    ...
    ::g::Uno::Collections::List__Add_fn(args, uPtr(module)->Item(::STRINGS[48/*"exports"*/]));
    ...
    return *__retval = ::STRINGS[79/*"module, exp...*/], void();
}
...
bool ScriptModule::Acceptor(uObject* obj)
{
    ...
    return uIs(obj, ::TYPES[67/*Fuse.Scripting.IModuleProvider*/]);
}
...
::g::Uno::IO::Bundle* ScriptModule::Bundle()
{
    ...
    ::g::Uno::UX::BundleFileSource* bfs = uAs< ::g::Uno::UX::BundleFileSource*>(File(), ::TYPES[70/*Uno.UX.BundleFileSource*/]);
...
uString* ScriptModule::ComputePath(uString* moduleId, bool* isFile)
{
    ...
    if (::g::Uno::String::StartsWith(uPtr(moduleId), ::STRINGS[71/*"."*/]))
    {
        *isFile = true;
        return ScriptModule::ComputePath1(GetSourcePath(), moduleId);
    }
    else if (::g::Uno::String::StartsWith(uPtr(moduleId), ::STRINGS[72/*"/"*/]))
    {
        *isFile = true;
...
::g::Fuse::Scripting::Module* ScriptModule::TryResolve(uString* path, bool isFile)
{
    ...
    if (!isFile)
    {
        ...
        if (::g::Uno::UX::Resource::TryFindGlobal(path, uDelegate::New(::TYPES[69/*Uno.Predicate<object>*/], (void*)ScriptModule__Acceptor_fn, this), &res))
        {
            uObject* mp = (uObject*)res;
            return ::g::Fuse::Scripting::IModuleProvider::GetModule(uInterface(uPtr(mp), ::TYPES[67/*Fuse.Scripting.IModuleProvider*/]));
        }
    }
...
uString* ScriptModule::ComputePath1(uString* sourcePath, uString* moduleId)
{
    ...
    for (int i = 0; i < uPtr(parts)->Length(); i++)
        if (::g::Uno::String::op_Equality(uPtr(parts)->Strong<uString*>(i), ::STRINGS[3/*""*/]))
            continue;
        else if (::g::Uno::String::op_Equality(uPtr(parts)->Strong<uString*>(i), ::STRINGS[71/*"."*/]))
            continue;
        else if (::g::Uno::String::op_Equality(uPtr(parts)->Strong<uString*>(i), ::STRINGS[73/*".."*/]))
            sourcePath = ::g::Uno::String::Replace(uPtr(::g::Uno::IO::Path::GetDirectoryName(sourcePath)), '\\', '/');
        else if (uPtr(sourcePath)->Length() > 0)
            sourcePath = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(sourcePath, ::STRINGS[72/*"/"*/]), uPtr(parts)->Strong<uString*>(i));
        else
...
bool ScriptModule::IsPathEqual(uString* src, uString* path)
{
    ...
    if (::g::Uno::String::op_Equality(src, ::g::Uno::String::op_Addition2(path, ::STRINGS[80/*".js"*/])))
        return true;
...
double Value::ToNumber(uObject* obj)
{
    ...
    if (uIs(obj, ::TYPES[71/*uint*/]))
        return (double)uUnbox<uint32_t>(::TYPES[71/*uint*/], obj);
