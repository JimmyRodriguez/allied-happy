...
public class MediaPlayer
{
    ...
    {
        android.view.Window window = Fuse.Preview.Dripdoctors.GetRootActivity().getWindow();
        ...
        try
        {
        	android.content.pm.ActivityInfo info = Fuse.Preview.Dripdoctors.GetRootActivity().getPackageManager().getActivityInfo(Fuse.Preview.Dripdoctors.GetRootActivity().getComponentName(), 0);
    ...
    public static void Pause1173(final Object handle)
    {
        ...
        if (player.isPlaying())
        {
        	android.media.AudioManager am = (android.media.AudioManager)Fuse.Preview.Dripdoctors.GetRootActivity().getSystemService(android.content.Context.AUDIO_SERVICE);
