...
static void MainView__Template2_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)MainView__Template2__New2_fn, 0, true, MainView__Template2_typeof(), 1, ::g::MainView_typeof()));
}
...
{
    uStackFrame __("MainView.Template2", ".ctor(MainView)");
