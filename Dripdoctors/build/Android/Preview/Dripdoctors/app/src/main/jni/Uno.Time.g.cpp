...
// C:\ProgramData\Uno\Packages\UnoCore\0.32.2\Source\Uno\Time\$.uno
// ----------------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\UnoCore\0.32.2\Source\Uno\Time\Utilities\$.uno
// --------------------------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\UnoCore\0.32.2\Source\Uno\Time\Timezones\$.uno
// --------------------------------------------------------------------------
...
{
    uStackFrame __("Uno.Time.Duration", "FromHours(long)");
...
{
    uStackFrame __("Uno.Time.LocalDateTime", "InUtc()");
...
{
    uStackFrame __("Uno.Time.ZonedDateTime", ".ctor(Uno.Time.LocalDateTime,Uno.Time.Offset,Uno.Time.DateTimeZone)");
    _localDateTime = localDateTime;
    _offset = offset;
    _zone = zone;
}
