...
{
    uStackFrame __("Dripdoctors_FuseControlsText_Value_Property", "Get()");
...
{
    uStackFrame __("Dripdoctors_FuseControlsText_Value_Property", "get_Object()");
...
{
    uStackFrame __("Dripdoctors_FuseControlsText_Value_Property", "Set(string,Uno.UX.IPropertyListener)");
...
{
    uStackFrame __("Dripdoctors_FuseControlsText_Value_Property", "get_SupportsOriginSetter()");
...
{
    uStackFrame __("Dripdoctors_FuseControlsText_Value_Property", ".ctor(Fuse.Controls.Text,Uno.UX.Selector)");
    ctor_1(name);
    _obj = obj;
}
