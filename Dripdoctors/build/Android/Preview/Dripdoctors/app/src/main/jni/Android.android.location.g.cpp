...
// C:\ProgramData\Uno\Packages\Android\0.32.1\Android\android\location\$.uno
// -------------------------------------------------------------------------
...
{
    uStackFrame __("Android.android.location.Location", "toString()");
    return *__retval = uCast< ::g::Android::java::lang::String*>(Location::toString_IMPL_8293(__this->_subclassed, __this->_javaObject), ::TYPES[0/*Android.java.lang.String*/]), void();
}
...
{
    uStackFrame __("Android.android.location.Location", "getAccuracy()");
...
{
    uStackFrame __("Android.android.location.Location", "getLatitude()");
...
{
    uStackFrame __("Android.android.location.Location", "getLongitude()");
...
{
    uStackFrame __("Android.android.location.Location", "getTime()");
...
{
    uStackFrame __("Android.android.location.Location", "_Init()");
...
{
    uStackFrame __("Android.android.location.Location", "getAccuracy_IMPL_8288(bool,Android.Base.Primitives.ujobject)");
    INIT_JNI;
...
{
    uStackFrame __("Android.android.location.Location", "getLatitude_IMPL_8271(bool,Android.Base.Primitives.ujobject)");
    INIT_JNI;
    CLASS_INIT(Location::_javaClass2(),Location::_Init2());
...
{
    uStackFrame __("Android.android.location.Location", "getLongitude_IMPL_8273(bool,Android.Base.Primitives.ujobject)");
    INIT_JNI;
    CLASS_INIT(Location::_javaClass2(),Location::_Init2());
...
{
    uStackFrame __("Android.android.location.Location", "getTime_IMPL_8267(bool,Android.Base.Primitives.ujobject)");
    INIT_JNI;
    CLASS_INIT(Location::_javaClass2(),Location::_Init2());
...
{
    uStackFrame __("Android.android.location.Location", "toString_IMPL_8293(bool,Android.Base.Primitives.ujobject)");
    INIT_JNI;
    CLASS_INIT(Location::_javaClass2(),Location::_Init2());
...
// {
static void LocationManager_build(uType* type)
{
    ::TYPES[1] = ::g::Android::java::util::List_typeof();
    ::TYPES[2] = ::g::Android::android::location::Location_typeof();
...
::g::Android::java::lang::Object_type* LocationManager_typeof()
{
    ...
    type->SetBase(::g::Android::java::lang::Object_typeof());
    type->fp_build_ = LocationManager_build;
    type->interface1.fp_Dispose = (void(*)(uObject*))::g::Android::Base::Wrappers::JWrapper__UnoIDisposableDispose_fn;
    type->interface0.fp__GetJavaObject = (void(*)(uObject*, jobject*))::g::Android::Base::Wrappers::JWrapper___GetJavaObject_fn;
    type->interface0.fp__IsSubclassed = (void(*)(uObject*, bool*))::g::Android::Base::Wrappers::JWrapper___IsSubclassed_fn;
    return type;
...
{
    uStackFrame __("Android.android.location.LocationManager", "getAllProviders()");
...
{
    uStackFrame __("Android.android.location.LocationManager", "getLastKnownLocation(Android.java.lang.String)");
    return uCast< ::g::Android::android::location::Location*>(LocationManager::getLastKnownLocation_IMPL_8331(_subclassed, _javaObject, (uObject*)arg0), ::TYPES[2/*Android.android.location.Location*/]);
}
...
{
    uStackFrame __("Android.android.location.LocationManager", "isProviderEnabled(Android.java.lang.String)");
...
{
    uStackFrame __("Android.android.location.LocationManager", "removeUpdates(Android.android.location.LocationListener)");
...
{
    uStackFrame __("Android.android.location.LocationManager", "requestLocationUpdates(Android.java.lang.String,long,float,Android.android.location.LocationListener,Android.android.os.Looper)");
    int64_t arg1_ = arg1;
    float arg2_ = arg2;
...
{
    uStackFrame __("Android.android.location.LocationManager", "requestSingleUpdate(Android.java.lang.String,Android.android.location.LocationListener,Android.android.os.Looper)");
...
{
    uStackFrame __("Android.android.location.LocationManager", "_Init()");
...
{
    uStackFrame __("Android.android.location.LocationManager", "getAllProviders_IMPL_8312(bool,Android.Base.Primitives.ujobject)");
    INIT_JNI;
...
{
    uStackFrame __("Android.android.location.LocationManager", "getLastKnownLocation_IMPL_8331(bool,Android.Base.Primitives.ujobject,Android.Base.Wrappers.IJWrapper)");
    INIT_JNI;
    CLASS_INIT(LocationManager::_javaClass2(),LocationManager::_Init2());
...
{
    uStackFrame __("Android.android.location.LocationManager", "isProviderEnabled_IMPL_8330(bool,Android.Base.Primitives.ujobject,Android.Base.Wrappers.IJWrapper)");
    INIT_JNI;
    CLASS_INIT(LocationManager::_javaClass2(),LocationManager::_Init2());
    jobject _obArg2 = ((!arg2_) ? NULL : ::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface(arg2_, ::g::Android::Base::Wrappers::IJWrapper_typeof())));
    bool result;
...
{
    uStackFrame __("Android.android.location.LocationManager", "removeUpdates_IMPL_8326(bool,Android.Base.Primitives.ujobject,Android.Base.Wrappers.IJWrapper)");
    INIT_JNI;
    CLASS_INIT(LocationManager::_javaClass2(),LocationManager::_Init2());
    jobject _obArg2 = ((!arg2_) ? NULL : ::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface(arg2_, ::g::Android::Base::Wrappers::IJWrapper_typeof())));
...
{
    uStackFrame __("Android.android.location.LocationManager", "requestLocationUpdates_IMPL_8318(bool,Android.Base.Primitives.ujobject,Android.Base.Wrappers.IJWrapper,long,float,Android.Base.Wrappers.IJWrapper,Android.Base.Wrappers.IJWrapper)");
    INIT_JNI;
    CLASS_INIT(LocationManager::_javaClass2(),LocationManager::_Init2());
    jobject _obArg2 = ((!arg2_) ? NULL : ::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface(arg2_, ::g::Android::Base::Wrappers::IJWrapper_typeof())));
...
{
    uStackFrame __("Android.android.location.LocationManager", "requestSingleUpdate_IMPL_8322(bool,Android.Base.Primitives.ujobject,Android.Base.Wrappers.IJWrapper,Android.Base.Wrappers.IJWrapper,Android.Base.Wrappers.IJWrapper)");
    INIT_JNI;
    CLASS_INIT(LocationManager::_javaClass2(),LocationManager::_Init2());
    jobject _obArg2 = ((!arg2_) ? NULL : ::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface(arg2_, ::g::Android::Base::Wrappers::IJWrapper_typeof())));
...
{
    uStackFrame __("Android.android.location.LocationManager", "get_GPS_PROVIDER()");
    INIT_JNI;
    CLASS_INIT(LocationManager::_javaClass2(),LocationManager::_Init2());
...
{
    uStackFrame __("Android.android.location.LocationManager", "get_NETWORK_PROVIDER()");
    INIT_JNI;
    CLASS_INIT(LocationManager::_javaClass2(),LocationManager::_Init2());
