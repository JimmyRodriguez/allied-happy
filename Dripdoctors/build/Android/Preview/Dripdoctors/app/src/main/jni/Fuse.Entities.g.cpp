...
// C:\ProgramData\Uno\Packages\Fuse.Entities\0.32.14\$.uno
// -------------------------------------------------------
...
void MeshBatchingEngine::DrawBatch(::g::Fuse::DrawContext* dc, ::g::Fuse::Entities::Material* material, ::g::Fuse::Drawing::Batching::Batch* batch, ::g::Uno::Float4x4 world, ::g::Uno::Float4x4 worldInverse)
{
    ...
    {
        _draw_e92d1425.Const(0, uPtr(uAs< ::g::Fuse::Entities::DefaultMaterial*>(material, ::TYPES[21/*Fuse.Entities.DefaultMaterial*/]))->DiffuseMap() != NULL);
        _draw_e92d1425.Const(1, uPtr(uAs< ::g::Fuse::Entities::DefaultMaterial*>(material, ::TYPES[21/*Fuse.Entities.DefaultMaterial*/]))->NormalMap() != NULL);
        _draw_e92d1425.Const(2, uPtr(uAs< ::g::Fuse::Entities::DefaultMaterial*>(material, ::TYPES[21/*Fuse.Entities.DefaultMaterial*/]))->SpecularMap() != NULL);
        _draw_e92d1425.Use();
        ...
        _draw_e92d1425.Uniform2(7, uPtr(uAs< ::g::Fuse::Entities::DefaultMaterial*>(material, ::TYPES[21/*Fuse.Entities.DefaultMaterial*/]))->Tiling());
        _draw_e92d1425.Uniform2(8, uPtr(uAs< ::g::Fuse::Entities::DefaultMaterial*>(material, ::TYPES[21/*Fuse.Entities.DefaultMaterial*/]))->Offset());
        _draw_e92d1425.Uniform6(9, uPtr(uAs< ::g::Fuse::Entities::DefaultMaterial*>(material, ::TYPES[21/*Fuse.Entities.DefaultMaterial*/]))->DiffuseColor());
        _draw_e92d1425.Uniform6(10, uPtr(uAs< ::g::Fuse::Entities::DefaultMaterial*>(material, ::TYPES[21/*Fuse.Entities.DefaultMaterial*/]))->SpecularColor());
        _draw_e92d1425.Uniform12(11, world);
        _draw_e92d1425.Uniform6(12, (((dc != NULL) ? (uObject*)uPtr(dc)->Viewport() : NULL) != NULL) ? ::g::Fuse::IViewport::ViewOrigin(uInterface(uPtr((dc != NULL) ? (uObject*)uPtr(dc)->Viewport() : NULL), ::TYPES[12/*Fuse.IViewport*/])) : ::g::Uno::Float3__New2(100.0f, 100.0f, 100.0f));
        _draw_e92d1425.Uniform(13, uPtr(uAs< ::g::Fuse::Entities::DefaultMaterial*>(material, ::TYPES[21/*Fuse.Entities.DefaultMaterial*/]))->Shininess());
        _draw_e92d1425.Uniform12(14, ::g::Uno::Matrix::Mul8(world, (((dc != NULL) ? (uObject*)dc->Viewport() : NULL) != NULL) ? ::g::Fuse::IViewport::ViewProjectionTransform(uInterface(uPtr((dc != NULL) ? (uObject*)dc->Viewport() : NULL), ::TYPES[12/*Fuse.IViewport*/])) : ::g::Uno::Matrix::Mul8((((dc != NULL) ? (uObject*)dc->Viewport() : NULL) != NULL) ? ::g::Fuse::IViewport::ViewTransform(uInterface(uPtr((dc != NULL) ? (uObject*)dc->Viewport() : NULL), ::TYPES[12/*Fuse.IViewport*/])) : ::g::Uno::Float4x4__Identity(), (((dc != NULL) ? (uObject*)dc->Viewport() : NULL) != NULL) ? ::g::Fuse::IViewport::ProjectionTransform(uInterface(uPtr((dc != NULL) ? (uObject*)dc->Viewport() : NULL), ::TYPES[12/*Fuse.IViewport*/])) : ::g::Uno::Float4x4__Identity())));
        _draw_e92d1425.Uniform12(15, ::g::Uno::Matrix::Transpose2(worldInverse));
        _draw_e92d1425.Sampler3(16, uPtr(uAs< ::g::Fuse::Entities::DefaultMaterial*>(material, ::TYPES[21/*Fuse.Entities.DefaultMaterial*/]))->DiffuseMap(), ::g::Uno::Graphics::SamplerState__LinearWrap());
        _draw_e92d1425.Sampler3(17, uPtr(uAs< ::g::Fuse::Entities::DefaultMaterial*>(material, ::TYPES[21/*Fuse.Entities.DefaultMaterial*/]))->NormalMap(), ::g::Uno::Graphics::SamplerState__LinearWrap());
        _draw_e92d1425.Sampler3(18, uPtr(uAs< ::g::Fuse::Entities::DefaultMaterial*>(material, ::TYPES[21/*Fuse.Entities.DefaultMaterial*/]))->SpecularMap(), ::g::Uno::Graphics::SamplerState__LinearWrap());
    ...
    for (int i = 0; i < uPtr(entries)->Count(); i++)
    {
        ...
        if ((bc >= (uPtr(batcher)->EntryCount() - 1)) || (i == (entries->Count() - 1)))
        {
            ...
            if (batch != NULL)
            {
                ...
                if (uIs(material, ::TYPES[21/*Fuse.Entities.DefaultMaterial*/]))
                {
                    _draw_3d7404f9.Const(0, uPtr(uAs< ::g::Fuse::Entities::DefaultMaterial*>(material, ::TYPES[21/*Fuse.Entities.DefaultMaterial*/]))->DiffuseMap() != NULL);
                    _draw_3d7404f9.Const(1, uPtr(uAs< ::g::Fuse::Entities::DefaultMaterial*>(material, ::TYPES[21/*Fuse.Entities.DefaultMaterial*/]))->NormalMap() != NULL);
                    _draw_3d7404f9.Const(2, uPtr(uAs< ::g::Fuse::Entities::DefaultMaterial*>(material, ::TYPES[21/*Fuse.Entities.DefaultMaterial*/]))->SpecularMap() != NULL);
                    _draw_3d7404f9.Use();
                    ...
                    _draw_3d7404f9.Sampler3(17, uPtr(uAs< ::g::Fuse::Entities::DefaultMaterial*>(material, ::TYPES[21/*Fuse.Entities.DefaultMaterial*/]))->DiffuseMap(), ::g::Uno::Graphics::SamplerState__LinearWrap());
                    _draw_3d7404f9.Sampler3(18, uPtr(uAs< ::g::Fuse::Entities::DefaultMaterial*>(material, ::TYPES[21/*Fuse.Entities.DefaultMaterial*/]))->NormalMap(), ::g::Uno::Graphics::SamplerState__LinearWrap());
                    _draw_3d7404f9.Sampler3(19, uPtr(uAs< ::g::Fuse::Entities::DefaultMaterial*>(material, ::TYPES[21/*Fuse.Entities.DefaultMaterial*/]))->SpecularMap(), ::g::Uno::Graphics::SamplerState__LinearWrap());
...
static void MeshRenderer_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("C:\\ProgramData\\Uno\\Packages\\Fuse.Entities\\0.32.14\\$.uno");
    ::TYPES[12] = ::g::Fuse::IViewport_typeof();
    ::TYPES[13] = ::g::Uno::Int_typeof();
    ::TYPES[4] = ::g::Fuse::Visual_typeof();
    ::TYPES[0] = ::g::Fuse::Entities::Entity_typeof();
...
void MeshRenderer__Draw_fn(MeshRenderer* __this, ::g::Fuse::DrawContext* dc)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[2/*"Drawing mesh!"*/], 1, ::STRINGS[3/*"C:\\Program...*/], 1338);
    __this->Validate();
