...
// C:\ProgramData\Uno\Packages\Fuse.Controls.WebView\0.32.14\Android\$.uno
// -----------------------------------------------------------------------
...
uString* WebViewForeign::GetTitle(::g::Java::Object* handle)
{
    uStackFrame __("Fuse.Android.Controls.WebViewUtils.WebViewForeign", "GetTitle(Java.Object)");
    {
        JniHelper _jni;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetTitle185", "(Ljava/lang/Object;)Ljava/lang/String;");
