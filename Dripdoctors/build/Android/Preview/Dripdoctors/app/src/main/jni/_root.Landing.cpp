// This file was generated based on C:\Users\rodriguez\workspace\FUSE\apps-fuse\Dripdoctors\build\Android\Preview\cache\Landing.g.uno.
...
static void Landing_build(uType* type)
{
    ...
    type->Reflection.SetFields(1,
        new uField("logoDripDoctors", 101));
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)Landing__New5_fn, 0, true, Landing_typeof(), 1, ::g::Fuse::Navigation::Router_typeof()));
}
...
{
    uStackFrame __("Landing", ".ctor(Fuse.Navigation.Router)");
    ctor_7();
    router = router1;
    InitializeUX();
}
...
{
    uStackFrame __("Landing", "InitializeUX()");
