...
: base(new [] {new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("127.0.0.1"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("192.168.1.3"), 12124)}, "C:\\Users\\rodriguez\\workspace\\FUSE\\apps-fuse\\Dripdoctors\\Dripdoctors.unoproj", GetBundle, new string[] { })
{
...
{
return Uno.IO.Bundle.Get("Dripdoctors");
}
}
}
