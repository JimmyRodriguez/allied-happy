...
// C:\ProgramData\Uno\Packages\UnoCore\0.32.2\Source\Uno\Time\Text\$.uno
// ---------------------------------------------------------------------
...
void NumberPart__Write_fn(NumberPart* __this, void* value, uString** __retval)
{
    ...
    int ret2;
    return *__retval = ::g::Uno::String::Format(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[0/*"{0:D"*/], uBox<int>(::g::Uno::Int_typeof(), __this->ExpectedSize())), ::STRINGS[1/*"}"*/]), uArray::Init<uObject*>(::TYPES[10/*object[]*/], 1, uBox<int>(::g::Uno::Int_typeof(), ::g::Uno::Math::Abs5((::g::Uno::Time::Text::PatternPart__Get_fn(__this, value, &ret2), ret2))))), void();
}
...
{
    ::TYPES[11] = ::g::Uno::Time::Text::FixedFormatPattern_typeof()->MakeType(OffsetPattern__OffsetBucket_typeof());
    ::TYPES[12] = ::g::Uno::Time::Text::IPatternPart_typeof()->MakeType(OffsetPattern__OffsetBucket_typeof())->Array();
    ::TYPES[13] = ::g::Uno::Time::Text::IPatternPart_typeof()->MakeType(OffsetPattern__OffsetBucket_typeof());
    ::TYPES[14] = ::g::Uno::Time::Text::SignPart_typeof()->MakeType(OffsetPattern__OffsetBucket_typeof());
    ::TYPES[15] = ::g::Uno::Action2_typeof()->MakeType(OffsetPattern__OffsetBucket_typeof(), ::g::Uno::Int_typeof());
    ::TYPES[16] = ::g::Uno::Func1_typeof()->MakeType(OffsetPattern__OffsetBucket_typeof(), ::g::Uno::Int_typeof());
    ::TYPES[17] = ::g::Uno::Time::Text::NumberPart_typeof()->MakeType(OffsetPattern__OffsetBucket_typeof());
    ::TYPES[18] = ::g::Uno::Time::Text::SeparatorPart_typeof()->MakeType(OffsetPattern__OffsetBucket_typeof());
    type->SetFields(0,
...
{
    _generalPattern = ((::g::Uno::Time::Text::FixedFormatPattern*)::g::Uno::Time::Text::FixedFormatPattern::New1(::TYPES[11/*Uno.Time.Text.FixedFormatPattern<Uno.Time.Text.OffsetPattern.OffsetBucket>*/], uArray::Init<uObject*>(::TYPES[12/*Uno.Time.Text.IPatternPart<Uno.Time.Text.OffsetPattern.OffsetBucket>[]*/], 6, (uObject*)((::g::Uno::Time::Text::SignPart*)::g::Uno::Time::Text::SignPart::New1(::TYPES[14/*Uno.Time.Text.SignPart<Uno.Time.Text.OffsetPattern.OffsetBucket>*/], true, uDelegate::New(::TYPES[15/*Uno.Action<Uno.Time.Text.OffsetPattern.OffsetBucket, int>*/], (void*)OffsetPattern__SetSign_fn, this), uDelegate::New(::TYPES[16/*Uno.Func<Uno.Time.Text.OffsetPattern.OffsetBucket, int>*/], (void*)OffsetPattern__GetSign_fn, this))), (uObject*)((::g::Uno::Time::Text::NumberPart*)::g::Uno::Time::Text::NumberPart::New1(::TYPES[17/*Uno.Time.Text.NumberPart<Uno.Time.Text.OffsetPattern.OffsetBucket>*/], 2, true, uDelegate::New(::TYPES[15/*Uno.Action<Uno.Time.Text.OffsetPattern.OffsetBucket, int>*/], (void*)OffsetPattern__SetHour_fn, this), uDelegate::New(::TYPES[16/*Uno.Func<Uno.Time.Text.OffsetPattern.OffsetBucket, int>*/], (void*)OffsetPattern__GetHour_fn, this))), (uObject*)((::g::Uno::Time::Text::SeparatorPart*)::g::Uno::Time::Text::SeparatorPart::New1(::TYPES[18/*Uno.Time.Text.SeparatorPart<Uno.Time.Text.OffsetPattern.OffsetBucket>*/], false, true, ':', 0)), (uObject*)((::g::Uno::Time::Text::NumberPart*)::g::Uno::Time::Text::NumberPart::New1(::TYPES[17/*Uno.Time.Text.NumberPart<Uno.Time.Text.OffsetPattern.OffsetBucket>*/], 2, false, uDelegate::New(::TYPES[15/*Uno.Action<Uno.Time.Text.OffsetPattern.OffsetBucket, int>*/], (void*)OffsetPattern__SetMinute_fn, this), uDelegate::New(::TYPES[16/*Uno.Func<Uno.Time.Text.OffsetPattern.OffsetBucket, int>*/], (void*)OffsetPattern__GetMinute_fn, this))), (uObject*)((::g::Uno::Time::Text::SeparatorPart*)::g::Uno::Time::Text::SeparatorPart::New1(::TYPES[18/*Uno.Time.Text.SeparatorPart<Uno.Time.Text.OffsetPattern.OffsetBucket>*/], false, true, ':', 0)), (uObject*)((::g::Uno::Time::Text::NumberPart*)::g::Uno::Time::Text::NumberPart::New1(::TYPES[17/*Uno.Time.Text.NumberPart<Uno.Time.Text.OffsetPattern.OffsetBucket>*/], 2, false, uDelegate::New(::TYPES[15/*Uno.Action<Uno.Time.Text.OffsetPattern.OffsetBucket, int>*/], (void*)OffsetPattern__SetSecond_fn, this), uDelegate::New(::TYPES[16/*Uno.Func<Uno.Time.Text.OffsetPattern.OffsetBucket, int>*/], (void*)OffsetPattern__GetSecond_fn, this))))));
}
...
void SeparatorPart__Write_fn(SeparatorPart* __this, void* value, uString** __retval)
{
    ...
    return *__retval = (__this->Obligatory() || __this->_show) ? (uString*)::g::Uno::Char::ToString(__this->_separator, ::TYPES[20/*char*/]) : (uString*)::g::Uno::String::Empty(), void();
}
