...
void Router::Pop()
{
    ...
    if (uPtr(_history)->Count() == 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[34/*"Cannot pop(...*/], this, ::STRINGS[1/*"C:\\Program...*/], 1672, ::STRINGS[35/*"Pop"*/]);
        return;
    }
...
::g::Fuse::Navigation::Route* Router::SetRoute(::g::Fuse::Navigation::Route* r, int gotoMode, int operation, bool userRequest)
{
    ...
    if (outR == NULL)
    {
        ...
        if (userRequest)
            ::g::Fuse::Diagnostics::UserError(msg, this, ::STRINGS[1/*"C:\\Program...*/], 1694, ::STRINGS[37/*"SetRoute"*/]);
        else
            ::g::Fuse::Diagnostics::InternalError(msg, this, ::STRINGS[1/*"C:\\Program...*/], 1696, ::STRINGS[37/*"SetRoute"*/]);
...
::g::Fuse::Navigation::Route* Router::SetRouteImpl(::g::Fuse::Visual* root, ::g::Fuse::Navigation::Route* r, int gotoMode, int operation)
{
    ...
    if (outlet == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::g::Uno::String::op_Addition1(::STRINGS[38/*"No router o...*/], r), this, ::STRINGS[1/*"C:\\Program...*/], 1713, ::STRINGS[39/*"SetRouteImpl"*/]);
        return NULL;
    }
    ...
    if (r->SubRoute != NULL)
    {
        if (active == NULL)
        {
            ::g::Fuse::Diagnostics::InternalError(::g::Uno::String::op_Addition1(::STRINGS[40/*"SubRoute re...*/], r), this, ::STRINGS[1/*"C:\\Program...*/], 1735, ::STRINGS[39/*"SetRouteImpl"*/]);
            return NULL;
        }
        else
        {
...
void Router::GoBack1(Router* r, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[30/*"GoBack take...*/], r, ::STRINGS[1/*"C:\\Program...*/], 1478, ::STRINGS[31/*"GoBack"*/]);
        return;
    }
...
void Router::Goto1(Router* r, uArray* args)
{
    ...
    if (where != NULL)
        ...
        ::g::Fuse::Diagnostics::UserError(::STRINGS[32/*"Router.goto...*/], r, ::STRINGS[1/*"C:\\Program...*/], 1452, ::STRINGS[33/*"Goto"*/]);
}
...
::g::Fuse::Navigation::Route* Router::ParseRoute(uArray* args, int pos)
{
    ...
    uString* path = uAs<uString*>(uPtr(args)->Strong<uObject*>(pos), ::TYPES[41/*string*/]);
...
static void StructuredNavigation_build(uType* type)
{
    ...
    ::TYPES[44] = ::g::Fuse::Motion::Simulation::Simulation_typeof();
    ::TYPES[23] = ::g::Uno::Action_typeof();
    ::TYPES[16] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[38] = ::g::Fuse::Node_typeof();
    ::TYPES[45] = ::g::Fuse::Motion::Simulation::MotionSimulation_typeof()->MakeType(::g::Uno::Float2_typeof());
    ::TYPES[2] = uObject_typeof();
    ::TYPES[3] = ::g::Uno::Int_typeof();
    ::TYPES[17] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[1] = ::g::Fuse::Visual_typeof();
    ::TYPES[46] = ::g::Fuse::Motion::MotionConfig_typeof();
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(::g::Fuse::Navigation::VisualNavigation_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::Navigation::VisualNavigation_type, interface1),
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(::g::Fuse::Navigation::VisualNavigation_type, interface2),
...
void StructuredNavigation__OnUnrooted_fn(StructuredNavigation* __this)
{
    ...
    {
        __this->_progress = (::g::Fuse::Motion::Simulation::MotionSimulation::get_Position_ex(uInterface(uPtr(__this->_region), ::TYPES[45/*Fuse.Motion.Simulation.MotionSimulation<float2>*/]), &ret10), ret10).X;
        __this->_region = NULL;
...
void StructuredNavigation::BeginSeek()
{
    ...
    {
        ResetRegionLimits();
        ::g::Fuse::Motion::Simulation::BoundedRegion2D::StartUser(uInterface(uPtr(_region), ::TYPES[43/*Fuse.Motion.Simulation.BoundedRegion2D*/]));
    }
...
{
    bool needUpdated = (_region != NULL) && !::g::Fuse::Motion::Simulation::Simulation::IsStatic(uInterface(uPtr(_region), ::TYPES[44/*Fuse.Motion.Simulation.Simulation*/]));
...
void StructuredNavigation::EndSeek(::g::Fuse::Navigation::EndSeekArgs* args)
{
    ...
    if (_region != NULL)
        ::g::Fuse::Motion::Simulation::BoundedRegion2D::EndUser(uInterface(uPtr(_region), ::TYPES[43/*Fuse.Motion.Simulation.BoundedRegion2D*/]), ::g::Uno::Float2__New2(uPtr(args)->Velocity(), 0.0f));

    if (!TransitionToChild(GetPage(targetIndex), false, true))
        ::g::Fuse::Motion::Simulation::BoundedRegion2D::Reset(uInterface(uPtr(_region), ::TYPES[43/*Fuse.Motion.Simulation.BoundedRegion2D*/]), (::g::Fuse::Motion::Simulation::MotionSimulation::get_Position_ex(uInterface(uPtr(_region), ::TYPES[45/*Fuse.Motion.Simulation.MotionSimulation<float2>*/]), &ret8), ret8));
}
...
void StructuredNavigation::GotoImpl(::g::Fuse::Visual* element, int mode)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[41/*"Attempting ...*/], element, ::STRINGS[1/*"C:\\Program...*/], 1990, ::STRINGS[42/*"GotoImpl"*/]);
        _active = NULL;
        return;
    }
...
void StructuredNavigation::Motion(::g::Fuse::Motion::MotionConfig* value)
{
    ...
    if (IsRootingCompleted())
        ::g::Fuse::Diagnostics::UserError(::STRINGS[47/*"Motion shou...*/], this, ::STRINGS[1/*"C:\\Program...*/], 1925, ::STRINGS[48/*"set_Motion"*/]);
}
...
void StructuredNavigation::OnUpdated()
{
    ...
    if (_region == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[43/*"Updated cal...*/], this, ::STRINGS[1/*"C:\\Program...*/], 2081, ::STRINGS[44/*"OnUpdated"*/]);
        return;
    }

    float prev = (::g::Fuse::Motion::Simulation::MotionSimulation::get_Position_ex(uInterface(uPtr(_region), ::TYPES[45/*Fuse.Motion.Simulation.MotionSimulation<float2>*/]), &ret11), ret11).X;
    ::g::Fuse::Motion::Simulation::Simulation::Update(uInterface(uPtr(_region), ::TYPES[44/*Fuse.Motion.Simulation.Simulation*/]), ::g::Fuse::Time::FrameInterval());
    ChangeProgress(prev, (::g::Fuse::Motion::Simulation::MotionSimulation::get_Position_ex(uInterface(uPtr(_region), ::TYPES[45/*Fuse.Motion.Simulation.MotionSimulation<float2>*/]), &ret12), ret12).X, 2);
...
{
    ::g::Uno::Float2 ret16;
    return (double)((_region == NULL) ? _progress : (::g::Fuse::Motion::Simulation::MotionSimulation::get_Position_ex(uInterface(uPtr(_region), ::TYPES[45/*Fuse.Motion.Simulation.MotionSimulation<float2>*/]), &ret16), ret16).X);
}
...
void StructuredNavigation::Seek(::g::Fuse::Navigation::UpdateSeekArgs* args)
{
    ...
    if (_region == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[45/*"Seek being ...*/], this, ::STRINGS[1/*"C:\\Program...*/], 2273, ::STRINGS[46/*"Seek"*/]);
        return;
    }

    float prev = (float)Progress();
    ::g::Fuse::Motion::Simulation::BoundedRegion2D::StepUser(uInterface(uPtr(_region), ::TYPES[43/*Fuse.Motion.Simulation.BoundedRegion2D*/]), ::g::Uno::Float2__New2(uPtr(args)->RelativeDelta(), 0.0f));
    ChangeProgress(prev, (::g::Fuse::Motion::Simulation::MotionSimulation::get_Position_ex(uInterface(uPtr(_region), ::TYPES[45/*Fuse.Motion.Simulation.MotionSimulation<float2>*/]), &ret13), ret13).X, 2);
...
void StructuredNavigation::SetProgress(float value)
{
    ...
    {
        ResetRegionLimits();
        prev = (::g::Fuse::Motion::Simulation::MotionSimulation::get_Position_ex(uInterface(uPtr(_region), ::TYPES[45/*Fuse.Motion.Simulation.MotionSimulation<float2>*/]), &ret14), ret14).X;
        ...
        value = (::g::Fuse::Motion::Simulation::MotionSimulation::get_Position_ex(uInterface(uPtr(_region), ::TYPES[45/*Fuse.Motion.Simulation.MotionSimulation<float2>*/]), &ret15), ret15).X;
    }
    else
    {
        prev = _progress;
...
static void SwipeNavigate_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("C:\\ProgramData\\Uno\\Packages\\Fuse.Navigation\\0.32.14\\$.uno");
    ::TYPES[47] = ::g::Fuse::Motion::Simulation::PointerVelocity_typeof()->MakeType(::g::Uno::Float2_typeof());
    ::TYPES[48] = ::g::Fuse::Gestures::DegreeSpan_typeof()->Array();
    ::TYPES[3] = ::g::Uno::Int_typeof();
    ::TYPES[2] = uObject_typeof();
    ::TYPES[23] = ::g::Uno::Action_typeof();
    ...
    ::TYPES[52] = ::g::Fuse::Visual_typeof()->MakeMethod(1, ::g::Fuse::Navigation::StructuredNavigation_typeof());
    ::TYPES[6] = ::g::Fuse::Elements::Element_typeof();
    type->SetInterfaces(
...
void SwipeNavigate::ctor_3()
{
    ...
    _forwardDirection = 1;
    _horizontalGesture = ::g::Fuse::Gestures::SwipeGestureHelper::New1(10.0f, uArray::Init< ::g::Fuse::Gestures::DegreeSpan*>(::TYPES[48/*Fuse.Gestures.DegreeSpan[]*/], 2, (::g::Fuse::Gestures::DegreeSpan*)::g::Fuse::Gestures::DegreeSpan::New1(75.0f, 105.0f), (::g::Fuse::Gestures::DegreeSpan*)::g::Fuse::Gestures::DegreeSpan::New1(-75.0f, -105.0f)));
    _verticalGesture = ::g::Fuse::Gestures::SwipeGestureHelper::New1(10.0f, uArray::Init< ::g::Fuse::Gestures::DegreeSpan*>(::TYPES[48/*Fuse.Gestures.DegreeSpan[]*/], 3, (::g::Fuse::Gestures::DegreeSpan*)::g::Fuse::Gestures::DegreeSpan::New1(-15.0f, 15.0f), (::g::Fuse::Gestures::DegreeSpan*)::g::Fuse::Gestures::DegreeSpan::New1(-165.0f, -180.0f), (::g::Fuse::Gestures::DegreeSpan*)::g::Fuse::Gestures::DegreeSpan::New1(165.0f, 180.0f)));
    _down = -1;
    _swipeAllow = 3;
    ctor_2();
...
void SwipeNavigate::OnPointerPressed(uObject* sender, ::g::Fuse::Input::PointerPressedArgs* args)
{
    ...
    if (_currentNavigation == NULL)
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[49/*"SwipeNaviga...*/], 1, ::STRINGS[1/*"C:\\Program...*/], 2618);
        return;
    }
...
::g::Fuse::Navigation::StructuredNavigation* SwipeNavigate::TryFindNavigation(::g::Fuse::Visual* parent)
{
    ...
    return (parent != NULL) ? (::g::Fuse::Navigation::StructuredNavigation*)uPtr(parent)->FirstChild(::TYPES[52/*Fuse.Visual.FirstChild<Fuse.Navigation.StructuredNavigation>*/]) : (::g::Fuse::Navigation::StructuredNavigation*)SwipeNavigate::TryFindNavigation(uPtr(parent)->ContextParent());
}
// }
...
{
    ::g::Fuse::Scripting::ScriptClass::Register(VisualNavigation_typeof(), uArray::Init< ::g::Fuse::Scripting::ScriptMethod*>(::TYPES[32/*Fuse.Scripting.ScriptMethod[]*/], 1, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[53/*Fuse.Scripting.ScriptMethod<Fuse.Navigation.VisualNavigation>*/], ::STRINGS[27/*"goto"*/], uDelegate::New(::TYPES[54/*Uno.Action<Fuse.Navigation.VisualNavigation, object[]>*/], (void*)VisualNavigation__gotoNode_fn), 2)));
}
...
static void VisualNavigation_build(uType* type)
{
    ...
    ::TYPES[32] = ::g::Fuse::Scripting::ScriptMethod_typeof()->Array();
    ::TYPES[33] = ::g::Fuse::Scripting::ScriptMethod_typeof();
    ::TYPES[53] = ::g::Fuse::Scripting::ScriptMethod1_typeof()->MakeType(VisualNavigation_typeof());
    ::TYPES[54] = ::g::Uno::Action2_typeof()->MakeType(VisualNavigation_typeof(), uObject_typeof()->Array());
    ::TYPES[55] = ::g::Uno::Collections::List_typeof()->MakeType(VisualNavigation__PageData_typeof());
    ::TYPES[56] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Fuse::Visual_typeof(), VisualNavigation__PageData_typeof());
    ::TYPES[1] = ::g::Fuse::Visual_typeof();
    ::TYPES[2] = uObject_typeof();
    ::TYPES[39] = ::g::Uno::Delegate_typeof();
    ::TYPES[16] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof());
...
void VisualNavigation::gotoNode(VisualNavigation* nav, uArray* args)
{
    ...
    if (target != NULL)
        ...
        ::g::Fuse::Diagnostics::UserError(::STRINGS[50/*"Navigation....*/], nav, ::STRINGS[1/*"C:\\Program...*/], 3021, ::STRINGS[51/*"gotoNode"*/]);
}
// }
