...
// C:\ProgramData\Uno\Packages\UnoCore\0.32.2\Source\Uno\Time\Calendars\$.uno
// --------------------------------------------------------------------------
...
void YearMonthDayCalculator::ctor_(int minYear, int maxYear, int monthsInYear, int64_t averageTicksPerYear, int64_t ticksAtStartOfYear1, uArray* eras)
{
    ...
    _eras = ((uArray*)::g::Uno::Time::Preconditions::CheckNotNull(::TYPES[3/*Uno.Time.Preconditions.CheckNotNull<Uno.Time.Calendars.Era[]>*/], eras, ::STRINGS[5/*"eras"*/]));
