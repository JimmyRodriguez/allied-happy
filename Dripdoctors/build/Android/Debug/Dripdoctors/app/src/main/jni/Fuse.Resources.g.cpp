...
// C:\ProgramData\Uno\Packages\Fuse.Elements\0.32.14\Resources\$.uno
// -----------------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\FuseCore\0.32.14\Resources\$.uno
// ------------------------------------------------------------
...
// public FileImageSource() [instance] :91
...
// public FileImageSource New() [static] :91
...
// public override sealed Fuse.Resources.ImageSourceState get_State() :256
...
static void HttpImageSourceImpl_build(uType* type)
{
    ...
    ::TYPES[1] = ::g::Uno::Exception_typeof();
    ::TYPES[14] = ::g::Uno::Action2_typeof()->MakeType(::g::Experimental::Http::HttpResponseHeader_typeof(), ::g::Uno::Buffer_typeof());
    ::TYPES[15] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[16] = uObject_typeof();
    ::TYPES[2] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::Graphics::Texture2D_typeof());
    ::TYPES[17] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::Exception_typeof());
    type->SetInterfaces(
        ::g::Fuse::Resources::IMemoryResource_typeof(), offsetof(::g::Fuse::Resources::LoadingImageSource_type, interface0));
    type->SetFields(13,
...
void HttpImageSourceImpl__AttemptLoad_fn(HttpImageSourceImpl* __this)
{
    try
    {
        ::g::Experimental::Http::HttpLoader::LoadBinary(__this->Url(), uDelegate::New(::TYPES[14/*Uno.Action<Experimental.Http.HttpResponseHeader, Uno.Buffer>*/], (void*)HttpImageSourceImpl__HttpCallback_fn, __this), uDelegate::New(::TYPES[15/*Uno.Action<string>*/], (void*)HttpImageSourceImpl__LoadFailed_fn, __this));
...
void HttpImageSourceImpl::HttpCallback(::g::Experimental::Http::HttpResponseHeader* response, ::g::Uno::Buffer* data)
{
    ...
    {
        Fail(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[4/*"HttpImageSo...*/], uBox<int>(::TYPES[6/*int*/], uPtr(response)->StatusCode())), ::STRINGS[5/*" "*/]), uPtr(response)->ReasonPhrase()), NULL);
        return;
    }
    ...
    HttpImageSourceImpl__BackgroundLoad::New1(data, _contentType, uDelegate::New(::TYPES[2/*Uno.Action<texture2D>*/], (void*)HttpImageSourceImpl__SuccessCallback_fn, this), uDelegate::New(::TYPES[17/*Uno.Action<Uno.Exception>*/], (void*)HttpImageSourceImpl__FailureCallback_fn, this));
}
...
// protected generated ImageSource() :454
...
// protected generated ImageSource() [instance] :454
...
{
    ::g::Fuse::Scripting::IEventSerializer::AddString(uInterface(uPtr(s), ::TYPES[21/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[9/*"reason"*/], __this->Reason);
}
...
// public enum ImageSourceState :422
...
// protected generated LoadingImageSource() :526
...
// public override sealed Fuse.Resources.ImageSourceState get_State() :652
...
// protected generated LoadingImageSource() [instance] :526
...
static void MultiDensityImageSource_build(uType* type)
{
    ...
    ::TYPES[23] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Resources::ImageSource_typeof());
    ::TYPES[24] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Resources::ImageSource_typeof());
    type->SetFields(4,
...
// public override sealed Fuse.Resources.ImageSourceState get_State() :843
...
{
    bool q = (uIs(o, ::TYPES[25/*float*/]) || uIs(o, ::TYPES[6/*int*/])) || uIs(o, ::TYPES[26/*double*/]);
    return q;
}
...
double NumericResourceConverter::InternConvert(uObject* o)
{
    ...
    if (uIs(o, ::TYPES[26/*double*/]))
        return uUnbox<double>(::TYPES[26/*double*/], o);
...
static void ProxyImageSource_build(uType* type)
{
    ...
    ::TYPES[16] = uObject_typeof();
    ::TYPES[28] = ::g::Uno::Graphics::Texture2D_typeof();
    type->SetFields(0,
...
// public ProxyImageSource(Fuse.Resources.ImageSource outer) :880
...
// public ProxyImageSource New(Fuse.Resources.ImageSource outer) :880
...
// public Fuse.Resources.ImageSourceState get_State() :973
...
// public ProxyImageSource(Fuse.Resources.ImageSource outer) [instance] :880
...
{
    return (_impl == NULL) ? uCast< ::g::Uno::Graphics::Texture2D*>(NULL, ::TYPES[28/*texture2D*/]) : (::g::Uno::Graphics::Texture2D*)uPtr(_impl)->GetTexture();
}
...
// public Fuse.Resources.ImageSourceState get_State() [instance] :973
...
// public ProxyImageSource New(Fuse.Resources.ImageSource outer) [static] :880
...
static void ResourceBinding_build(uType* type)
{
    ...
    ::TYPES[30] = ::g::Fuse::Resources::IResourceConverter_typeof();
    ::TYPES[31] = ::g::Fuse::Resources::ResourceConverters_typeof();
    ::TYPES[0] = ::g::Uno::Action_typeof();
    type->SetPrecalc(
...
void ResourceBinding::OnChanged()
{
    ...
    if (uPtr(Parent())->TryGetResource(Key(), uDelegate::New(::TYPES[29/*Uno.Predicate<object>*/], uInterface(uPtr(_converter), __types[1]), offsetof(::g::Fuse::Resources::IResourceConverter, fp_Accept)), &resource))
...
{
    ResourceConverters::_converters_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[32/*Uno.Collections.Dictionary<Uno.Type, object>*/]));
}

static void ResourceConverters_build(uType* type)
{
    ::TYPES[32] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::Type_typeof(), uObject_typeof());
    ::TYPES[33] = ::g::Uno::Type_typeof();
    ::TYPES[16] = uObject_typeof();
    ::TYPES[34] = ::g::Fuse::Resources::GenericResourceConverter_typeof();
    ::TYPES[30] = ::g::Fuse::Resources::IResourceConverter_typeof();
    type->SetFields(0,
...
{
    uType* __types[] = {
        ::TYPES[34/*Fuse.Resources.GenericResourceConverter`1*/]->MakeType(__type->U(0)),
        __type->U(0),
        ::TYPES[30/*Fuse.Resources.IResourceConverter`1*/]->MakeType(__type->U(0)),
    };
    ...
    {
        if (::g::Uno::Type::op_Equality(__types[1], ::TYPES[25/*float*/]))
            converter = ::g::Fuse::Resources::FloatResourceConverter::New1();
        else if (::g::Uno::Type::op_Equality(__types[1], ::TYPES[26/*double*/]))
...
{
    ResourceRegistry::_handlers_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[35/*Uno.Collections.Dictionary<string, Uno.Collections.List<Uno.Action>>*/]));
}

static void ResourceRegistry_build(uType* type)
{
    ::TYPES[35] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Action_typeof()));
    ::TYPES[36] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Action_typeof());
    ::TYPES[37] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Uno::Action_typeof());
    type->SetFields(0,
...
void ResourceRegistry::AddResourceChangedHandler(uString* key, uDelegate* handler)
{
    ...
    if (!(::g::Uno::Collections::Dictionary__ContainsKey_fn(uPtr(ResourceRegistry::_handlers()), key, &ret2), ret2))
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(ResourceRegistry::_handlers()), key, (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[36/*Uno.Collections.List<Uno.Action>*/]));
...
void ResourceRegistry::NotifyResourceChanged(uString* key)
{
    ...
    if ((::g::Uno::Collections::Dictionary__TryGetValue_fn(uPtr(ResourceRegistry::_handlers()), key, (void**)(&list), &ret4), ret4))
        ...
        for (::g::Uno::Collections::List__Enumerator<uStrong<uDelegate*> > enum1 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(list), &ret5), ret5); enum1.MoveNext(::TYPES[37/*Uno.Collections.List<Uno.Action>.Enumerator*/]); )
        {
            uDelegate* h = enum1.Current(::TYPES[37/*Uno.Collections.List<Uno.Action>.Enumerator*/]);
            uPtr(h)->InvokeVoid();
        }
}
...
// public override sealed Fuse.Resources.ImageSourceState get_State() :1105
