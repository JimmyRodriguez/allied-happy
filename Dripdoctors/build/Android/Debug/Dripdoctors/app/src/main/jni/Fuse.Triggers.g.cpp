...
{
    ::TYPES[3] = ::g::Fuse::ITranslationMode_typeof();
    ::TYPES[4] = ::g::Fuse::Animations::IResizeMode_typeof();
    ::TYPES[5] = ::g::Fuse::IScalingMode_typeof();
    ::TYPES[6] = ::g::Uno::Float4_typeof();
    ::TYPES[7] = ::g::Uno::Float3_typeof();
    ::TYPES[8] = uObject_typeof();
    ::TYPES[9] = ::g::Fuse::VisualEvent_typeof()->MakeType(::g::Fuse::Triggers::LayoutTransitionedHandler_typeof(), ::g::Fuse::Triggers::LayoutTransitionedArgs_typeof());
    type->SetFields(0,
...
bool LayoutTransition::GetPositionChange(::g::Fuse::Visual* n, ::g::Uno::Float2* oldPos, ::g::Uno::Float2* newPos)
{
    ...
    ::g::Uno::Float4 f = (v == NULL) ? ::g::Uno::Float4__New1(0.0f) : uUnbox< ::g::Uno::Float4>(::TYPES[6/*float4*/], v);
...
bool LayoutTransition::GetSizeChange(::g::Fuse::Visual* n, ::g::Uno::Float2* oldSize, ::g::Uno::Float2* newSize)
{
    ...
    {
        ::g::Uno::Float4 f = uUnbox< ::g::Uno::Float4>(::TYPES[6/*float4*/], res);
...
::g::Uno::Float3 LayoutTransition::GetWorldPositionChange(::g::Fuse::Visual* n)
{
    ...
    if (v != NULL)
        return uUnbox< ::g::Uno::Float3>(::TYPES[7/*float3*/], v);
    else
...
{
    LayoutTransition_typeof()->Init();
    uPtr(uPtr(n)->Properties())->Set(LayoutTransition::_positionChange(), uBox(::TYPES[6/*float4*/], ::g::Uno::Float4__New7(oldPos, newPos)));
}
...
{
    LayoutTransition_typeof()->Init();
    uPtr(uPtr(n)->Properties())->Set(LayoutTransition::_sizeChange(), uBox(::TYPES[6/*float4*/], ::g::Uno::Float4__New7(oldSize, newSize)));
}
...
{
    LayoutTransition_typeof()->Init();
    uPtr(uPtr(n)->Properties())->Set(LayoutTransition::_worldPositionChange(), uBox(::TYPES[7/*float3*/], change));
}
...
{
    ::STRINGS[0] = uString::Const("Double removal of Visual");
    ::STRINGS[1] = uString::Const("C:\\ProgramData\\Uno\\Packages\\Fuse.Triggers\\0.32.14\\$.uno");
    ::STRINGS[2] = uString::Const("Fuse.IBeginRemoveVisualListener.OnBeginRemoveVisual");
    ::STRINGS[3] = uString::Const("Unexpected done");
    ::STRINGS[4] = uString::Const("OnDone");
    ::TYPES[8] = uObject_typeof();
...
void RemovingAnimation__FuseIBeginRemoveVisualListenerOnBeginRemoveVisual_fn(RemovingAnimation* __this, ::g::Fuse::PendingRemoveVisual* pr)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[0/*"Double remo...*/], __this, ::STRINGS[1/*"C:\\Program...*/], 695, ::STRINGS[2/*"Fuse.IBegin...*/]);
        return;
    }

    __this->_args = pr;
    uPtr(__this->_args)->AddSubscriber();
    __this->Activate(uDelegate::New(::TYPES[14/*Uno.Action*/], (void*)RemovingAnimation__OnDone_fn, __this));
}
...
void RemovingAnimation::OnDone()
{
    if (_args == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[3/*"Unexpected ...*/], this, ::STRINGS[1/*"C:\\Program...*/], 708, ::STRINGS[4/*"OnDone"*/]);
        return;
    }
...
{
    ::g::Fuse::Scripting::ScriptClass::Register(State_typeof(), uArray::Init< ::g::Fuse::Scripting::ScriptMethod*>(::TYPES[16/*Fuse.Scripting.ScriptMethod[]*/], 1, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[18/*Fuse.Scripting.ScriptMethod<Fuse.Triggers.State>*/], ::STRINGS[5/*"goto"*/], uDelegate::New(::TYPES[19/*Uno.Action<Fuse.Triggers.State, object[]>*/], (void*)State__goto__fn), 2)));
}

static void State_build(uType* type)
{
    ::STRINGS[5] = uString::Const("goto");
    ::STRINGS[6] = uString::Const("Cannot call `Goto` on an unrooted `State`");
    ::STRINGS[1] = uString::Const("C:\\ProgramData\\Uno\\Packages\\Fuse.Triggers\\0.32.14\\$.uno");
    ::STRINGS[7] = uString::Const("Goto");
    ::TYPES[15] = ::g::Uno::Type_typeof();
    ::TYPES[16] = ::g::Fuse::Scripting::ScriptMethod_typeof()->Array();
    ::TYPES[17] = ::g::Fuse::Scripting::ScriptMethod_typeof();
    ::TYPES[18] = ::g::Fuse::Scripting::ScriptMethod1_typeof()->MakeType(State_typeof());
    ::TYPES[19] = ::g::Uno::Action2_typeof()->MakeType(State_typeof(), uObject_typeof()->Array());
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(::g::Fuse::Triggers::Trigger_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface1),
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(::g::Fuse::Triggers::Trigger_type, interface2),
...
void State::Goto()
{
    if (_stateGroup == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[6/*"Cannot call...*/], NULL, ::STRINGS[1/*"C:\\Program...*/], 1117, ::STRINGS[7/*"Goto"*/]);
        return;
    }
...
{
    ::g::Fuse::Scripting::ScriptClass::Register(StateGroup_typeof(), uArray::Init< ::g::Fuse::Scripting::ScriptMethod*>(::TYPES[16/*Fuse.Scripting.ScriptMethod[]*/], 2, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[20/*Fuse.Scripting.ScriptMethod<Fuse.Triggers.StateGroup>*/], ::STRINGS[5/*"goto"*/], uDelegate::New(::TYPES[21/*Uno.Action<Fuse.Triggers.StateGroup, object[]>*/], (void*)StateGroup__goto__fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[20/*Fuse.Scripting.ScriptMethod<Fuse.Triggers.StateGroup>*/], ::STRINGS[8/*"gotoNext"*/], uDelegate::New(::TYPES[21/*Uno.Action<Fuse.Triggers.StateGroup, object[]>*/], (void*)StateGroup__gotoNext_fn), 2)));
}

static void StateGroup_build(uType* type)
{
    ::STRINGS[5] = uString::Const("goto");
    ::STRINGS[8] = uString::Const("gotoNext");
    ::STRINGS[9] = uString::Const("StateGroup.goto requires 1 argument");
    ::STRINGS[1] = uString::Const("C:\\ProgramData\\Uno\\Packages\\Fuse.Triggers\\0.32.14\\$.uno");
    ::STRINGS[10] = uString::Const("goto_");
    ::STRINGS[11] = uString::Const("Unable to find State with Name: ");
    ::STRINGS[12] = uString::Const("gotoName");
    ::TYPES[15] = ::g::Uno::Type_typeof();
    ::TYPES[16] = ::g::Fuse::Scripting::ScriptMethod_typeof()->Array();
    ::TYPES[17] = ::g::Fuse::Scripting::ScriptMethod_typeof();
    ::TYPES[20] = ::g::Fuse::Scripting::ScriptMethod1_typeof()->MakeType(StateGroup_typeof());
    ::TYPES[21] = ::g::Uno::Action2_typeof()->MakeType(StateGroup_typeof(), uObject_typeof()->Array());
    ::TYPES[0] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Triggers::State_typeof());
    ::TYPES[1] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[2] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Triggers::State_typeof());
    ::TYPES[8] = uObject_typeof();
...
void StateGroup::Goto(::g::Fuse::Triggers::State* next)
{
    ...
    _active = next;
    ::g::Fuse::UpdateManager::AddDeferredAction(uDelegate::New(::TYPES[14/*Uno.Action*/], (void*)StateGroup__GotoImpl__Go_fn, uPtr((collection4 = StateGroup__GotoImpl::New1(), uPtr(collection4)->Next = next, uPtr(collection4)->Group = this, collection4))), -1, 0);
}
...
void StateGroup::goto_(StateGroup* n, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[9/*"StateGroup....*/], n, ::STRINGS[1/*"C:\\Program...*/], 778, ::STRINGS[10/*"goto_"*/]);
        return;
    }

    if (uIs((uObject*)uPtr(args)->Strong<uObject*>(0), ::TYPES[22/*string*/]))
        StateGroup::gotoName(n, uAs<uString*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[22/*string*/]));
    else
...
void StateGroup::gotoName(StateGroup* n, uString* name)
{
    ...
    if (state == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[11/*"Unable to f...*/], name), n, ::STRINGS[1/*"C:\\Program...*/], 758, ::STRINGS[12/*"gotoName"*/]);
        return;
    }
...
{
    Timeline::_progressName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[13/*"Progress"*/]);
    ::g::Fuse::Scripting::ScriptClass::Register(Timeline_typeof(), uArray::Init< ::g::Fuse::Scripting::ScriptMethod*>(::TYPES[16/*Fuse.Scripting.ScriptMethod[]*/], 9, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[29/*Fuse.Scripting.ScriptMethod<Fuse.Triggers.Timeline>*/], ::STRINGS[14/*"pause"*/], uDelegate::New(::TYPES[30/*Uno.Action<Fuse.Triggers.Timeline, object[]>*/], (void*)Timeline__pause_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[29/*Fuse.Scripting.ScriptMethod<Fuse.Triggers.Timeline>*/], ::STRINGS[15/*"pulse"*/], uDelegate::New(::TYPES[30/*Uno.Action<Fuse.Triggers.Timeline, object[]>*/], (void*)Timeline__pulse_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[29/*Fuse.Scripting.ScriptMethod<Fuse.Triggers.Timeline>*/], ::STRINGS[16/*"pulseBackward"*/], uDelegate::New(::TYPES[30/*Uno.Action<Fuse.Triggers.Timeline, object[]>*/], (void*)Timeline__pulseBackward_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[29/*Fuse.Scripting.ScriptMethod<Fuse.Triggers.Timeline>*/], ::STRINGS[17/*"pulseForward"*/], uDelegate::New(::TYPES[30/*Uno.Action<Fuse.Triggers.Timeline, object[]>*/], (void*)Timeline__pulseForward_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[29/*Fuse.Scripting.ScriptMethod<Fuse.Triggers.Timeline>*/], ::STRINGS[18/*"play"*/], uDelegate::New(::TYPES[30/*Uno.Action<Fuse.Triggers.Timeline, object[]>*/], (void*)Timeline__resume_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[29/*Fuse.Scripting.ScriptMethod<Fuse.Triggers.Timeline>*/], ::STRINGS[19/*"playTo"*/], uDelegate::New(::TYPES[30/*Uno.Action<Fuse.Triggers.Timeline, object[]>*/], (void*)Timeline__playTo_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[29/*Fuse.Scripting.ScriptMethod<Fuse.Triggers.Timeline>*/], ::STRINGS[20/*"resume"*/], uDelegate::New(::TYPES[30/*Uno.Action<Fuse.Triggers.Timeline, object[]>*/], (void*)Timeline__resume_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[29/*Fuse.Scripting.ScriptMethod<Fuse.Triggers.Timeline>*/], ::STRINGS[21/*"seek"*/], uDelegate::New(::TYPES[30/*Uno.Action<Fuse.Triggers.Timeline, object[]>*/], (void*)Timeline__seek_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[29/*Fuse.Scripting.ScriptMethod<Fuse.Triggers.Timeline>*/], ::STRINGS[22/*"stop"*/], uDelegate::New(::TYPES[30/*Uno.Action<Fuse.Triggers.Timeline, object[]>*/], (void*)Timeline__stop_fn), 2)));
}

static void Timeline_build(uType* type)
{
    ::STRINGS[13] = uString::Const("Progress");
    ::STRINGS[14] = uString::Const("pause");
    ::STRINGS[15] = uString::Const("pulse");
    ::STRINGS[16] = uString::Const("pulseBackward");
    ::STRINGS[17] = uString::Const("pulseForward");
    ::STRINGS[18] = uString::Const("play");
    ::STRINGS[19] = uString::Const("playTo");
    ::STRINGS[20] = uString::Const("resume");
    ::STRINGS[21] = uString::Const("seek");
    ::STRINGS[22] = uString::Const("stop");
    ::STRINGS[23] = uString::Const("Timeline.seek requires 1 argument");
    ::STRINGS[1] = uString::Const("C:\\ProgramData\\Uno\\Packages\\Fuse.Triggers\\0.32.14\\$.uno");
    ::TYPES[15] = ::g::Uno::Type_typeof();
    ::TYPES[16] = ::g::Fuse::Scripting::ScriptMethod_typeof()->Array();
    ::TYPES[17] = ::g::Fuse::Scripting::ScriptMethod_typeof();
    ::TYPES[29] = ::g::Fuse::Scripting::ScriptMethod1_typeof()->MakeType(Timeline_typeof());
    ::TYPES[30] = ::g::Uno::Action2_typeof()->MakeType(Timeline_typeof(), uObject_typeof()->Array());
...
{
    _targetProgress = 1.0;
    DirectActivate(uDelegate::New(::TYPES[14/*Uno.Action*/], (void*)Timeline__BypassOff_fn, this));
}
...
void Timeline::playTo(Timeline* n, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[23/*"Timeline.se...*/], n, ::STRINGS[1/*"C:\\Program...*/], 1438, ::STRINGS[19/*"playTo"*/]);
        return;
    }
...
void Timeline::seek(Timeline* n, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[23/*"Timeline.se...*/], n, ::STRINGS[1/*"C:\\Program...*/], 1487, ::STRINGS[21/*"seek"*/]);
        return;
    }
...
{
    ::STRINGS[24] = uString::Const("AddContent called prior to having a Parent");
    ::STRINGS[1] = uString::Const("C:\\ProgramData\\Uno\\Packages\\Fuse.Triggers\\0.32.14\\$.uno");
    ::STRINGS[25] = uString::Const("AddContent");
    ::STRINGS[26] = uString::Const("Could not locate trigger in parent, content not added: ");
    ::STRINGS[27] = uString::Const("Trigger.OnPlaybackdone called with _animState == null");
    ::STRINGS[28] = uString::Const("Fuse.Animations.IPlayerFeedback.OnPlaybackDone");
    ::STRINGS[29] = uString::Const("Trigger started prior to being rooted: ");
    ...
    ::TYPES[38] = ::g::Fuse::Animations::IPlayerFeedback_typeof();
    ::TYPES[14] = ::g::Uno::Action_typeof();
    ::TYPES[10] = ::g::Uno::Int_typeof();
...
void Trigger__FuseAnimationsIPlayerFeedbackOnPlaybackDone_fn(Trigger* __this, uObject* s)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[27/*"Trigger.OnP...*/], __this, ::STRINGS[1/*"C:\\Program...*/], 1800, ::STRINGS[28/*"Fuse.Animat...*/]);
        return;
    }
...
void Trigger::AddContent(::g::Fuse::Node* target)
{
    ...
    if (Parent() == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[24/*"AddContent ...*/], this, ::STRINGS[1/*"C:\\Program...*/], 1718, ::STRINGS[25/*"AddContent"*/]);
        return;
    }

    int where = (::g::Uno::Collections::EnumerableExtensions__IndexOf_fn(::TYPES[35/*Uno.Collections.EnumerableExtensions.IndexOf<Fuse.Node>*/], uPtr(Parent())->Children(), this, &ret1), ret1);

    if (where == -1)
    {
        ::g::Fuse::Diagnostics::InternalError(::g::Uno::String::op_Addition1(::STRINGS[26/*"Could not l...*/], this), this, ::STRINGS[1/*"C:\\Program...*/], 1726, ::STRINGS[25/*"AddContent"*/]);
        return;
    }
    ...
    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(_nodes), ::TYPES[34/*Uno.Collections.ICollection<Fuse.Node>*/])); ++i)
        ::g::Uno::Collections::IList::Insert_ex(uInterface(uPtr(uPtr(Parent())->Children()), ::TYPES[37/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(where + i), (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(_nodes), ::TYPES[37/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret2), ret2));
}
...
{
    PlayEnd(false, uDelegate::New(::TYPES[14/*Uno.Action*/], (void*)Trigger__StopAction_fn, this));
}
...
{
    PlayEnd(false, uDelegate::New(::TYPES[14/*Uno.Action*/], (void*)Trigger__PlayOn_fn, this));
}
...
void Trigger::OnNodeAdded(::g::Fuse::Node* n)
{
    if (IsRootingCompleted() && _isStarted)
        ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(Parent())->Children()), ::TYPES[34/*Uno.Collections.ICollection<Fuse.Node>*/]), n);
}
...
void Trigger::Pulse()
{
    ...
    SetPlayDirection(0);
    DirectActivate(uDelegate::New(::TYPES[14/*Uno.Action*/], (void*)Trigger__DirectDeactivate_fn, this));
}
...
void Trigger::RemoveContent(::g::Fuse::Node* target)
{
    ...
    if ((_nodes != NULL) && (Parent() != NULL))
        ...
        for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(_nodes), ::TYPES[34/*Uno.Collections.ICollection<Fuse.Node>*/])); ++i)
            uPtr(Parent())->BeginRemoveChild((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(_nodes), ::TYPES[37/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret5), ret5), NULL);
}
...
void Trigger::Start()
{
    ...
    {
        if (!IsRootingStarted())
            U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition1(::STRINGS[29/*"Trigger sta...*/], this)));
...
bool WhileCompleted::IsCompleted(::g::Fuse::Visual* n)
{
    ...
    if (!uIs(v, ::TYPES[45/*bool*/]))
        return false;

    return uUnbox<bool>(::TYPES[45/*bool*/], v);
}
...
void WhileCompleted::SetState(::g::Fuse::Visual* n, bool paused)
{
    ...
    if (v != paused)
    {
        uPtr(uPtr(n)->Properties())->Set(WhileCompleted::_whileCompletedProp(), uBox(::TYPES[45/*bool*/], paused));
...
{
    ::TYPES[46] = ::g::Uno::EventHandler_typeof();
    type->SetInterfaces(
...
{
    ::g::Fuse::Triggers::Trigger__OnRooted_fn(__this);
    uPtr(__this->Parent())->add_IsContextEnabledChanged(uDelegate::New(::TYPES[46/*Uno.EventHandler*/], (void*)WhileEnabledDisabledTrigger__OnIsContextEnabledChanged_fn, __this));
...
{
    uPtr(__this->Parent())->remove_IsContextEnabledChanged(uDelegate::New(::TYPES[46/*Uno.EventHandler*/], (void*)WhileEnabledDisabledTrigger__OnIsContextEnabledChanged_fn, __this));
    ::g::Fuse::Triggers::Trigger__OnUnrooted_fn(__this);
}
...
{
    ::STRINGS[30] = uString::Const("WhileFailed.Message");
    ::TYPES[45] = ::g::Uno::Bool_typeof();
    ::TYPES[8] = uObject_typeof();
    ::TYPES[34] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[37] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Node_typeof());
...
void WhileFailed::SetState(::g::Fuse::Visual* n, bool failed, uString* message)
{
    ...
    if (v != failed)
    {
        uPtr(uPtr(n)->Properties())->Set(WhileFailed::_whileFailedProp(), uBox(::TYPES[45/*bool*/], failed));
        n->SetResource(::STRINGS[30/*"WhileFailed...*/], message);
...
void WhileLoading::SetState(::g::Fuse::Visual* n, bool loading)
{
    ...
    if (v != loading)
    {
        uPtr(uPtr(n)->Properties())->Set(WhileLoading::_whileLoadingProp(), uBox(::TYPES[45/*bool*/], loading));
...
void WhilePaused::SetState(::g::Fuse::Visual* n, bool paused)
{
    ...
    if (v != paused)
    {
        uPtr(uPtr(n)->Properties())->Set(WhilePaused::_whilePausedProp(), uBox(::TYPES[45/*bool*/], paused));
...
void WhilePlaying::SetState(::g::Fuse::Visual* n, bool playing)
{
    ...
    if (v != playing)
    {
        uPtr(uPtr(n)->Properties())->Set(WhilePlaying::_whilePlayingProp(), uBox(::TYPES[45/*bool*/], playing));
...
{
    ::STRINGS[31] = uString::Const("`Pulse` on a `WhileValue` will be removed, create a `Timeline` instead.");
    ::STRINGS[1] = uString::Const("C:\\ProgramData\\Uno\\Packages\\Fuse.Triggers\\0.32.14\\$.uno");
...
void WhileValue::Pulse1()
{
    ...
    {
        ::g::Fuse::Diagnostics::Deprecated(::STRINGS[31/*"`Pulse` on ...*/], this, ::STRINGS[1/*"C:\\Program...*/], 2786, ::STRINGS[32/*"Pulse"*/]);
