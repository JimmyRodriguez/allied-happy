...
static void Context_build(uType* type)
{
    ...
    ::STRINGS[5] = uString::Const("C:\\ProgramData\\Uno\\Packages\\Fuse.Scripting.V8\\0.32.14\\$.uno");
...
void Context::OnScriptException(::g::Fuse::Scripting::V8::Simple::ScriptException* e)
{
    ...
    ::g::Fuse::Diagnostics::UnknownException(::STRINGS[4/*"Script error"*/], result, NULL, ::STRINGS[5/*"C:\\Program...*/], 135, ::STRINGS[6/*"OnScriptExc...*/]);
    U_THROW(result);
}
// }
