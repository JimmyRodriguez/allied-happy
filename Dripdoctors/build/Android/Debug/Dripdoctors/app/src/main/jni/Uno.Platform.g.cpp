...
// C:\ProgramData\Uno\Packages\UnoCore\0.32.2\Source\Uno\Platform\$.uno
// --------------------------------------------------------------------
...
static void Window_build(uType* type)
{
    ...
    ::TYPES[6] = ::g::Uno::EventHandler1_typeof()->MakeType(::g::Uno::Platform::PointerEventArgs_typeof());
    ::TYPES[7] = ::g::Uno::EventHandler1_typeof()->MakeType(::g::Uno::Platform::TextInputEventArgs_typeof());
    type->SetFields(0,
...
{
    KeyPressed1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(KeyPressed1, value), ::TYPES[5/*Uno.EventHandler<Uno.Platform.KeyEventArgs>*/]);
}
...
{
    KeyPressed1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(KeyPressed1, value), ::TYPES[5/*Uno.EventHandler<Uno.Platform.KeyEventArgs>*/]);
}
...
{
    KeyReleased1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(KeyReleased1, value), ::TYPES[5/*Uno.EventHandler<Uno.Platform.KeyEventArgs>*/]);
}
...
{
    KeyReleased1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(KeyReleased1, value), ::TYPES[5/*Uno.EventHandler<Uno.Platform.KeyEventArgs>*/]);
}
...
{
    PointerEntered1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(PointerEntered1, value), ::TYPES[6/*Uno.EventHandler<Uno.Platform.PointerEventArgs>*/]);
}
...
{
    PointerEntered1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(PointerEntered1, value), ::TYPES[6/*Uno.EventHandler<Uno.Platform.PointerEventArgs>*/]);
}
...
{
    PointerMoved1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(PointerMoved1, value), ::TYPES[6/*Uno.EventHandler<Uno.Platform.PointerEventArgs>*/]);
}
...
{
    PointerMoved1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(PointerMoved1, value), ::TYPES[6/*Uno.EventHandler<Uno.Platform.PointerEventArgs>*/]);
}
...
{
    PointerPressed1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(PointerPressed1, value), ::TYPES[6/*Uno.EventHandler<Uno.Platform.PointerEventArgs>*/]);
}
...
{
    PointerPressed1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(PointerPressed1, value), ::TYPES[6/*Uno.EventHandler<Uno.Platform.PointerEventArgs>*/]);
}
...
{
    PointerReleased1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(PointerReleased1, value), ::TYPES[6/*Uno.EventHandler<Uno.Platform.PointerEventArgs>*/]);
}
...
{
    PointerReleased1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(PointerReleased1, value), ::TYPES[6/*Uno.EventHandler<Uno.Platform.PointerEventArgs>*/]);
}
...
{
    PointerWheelChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(PointerWheelChanged1, value), ::TYPES[6/*Uno.EventHandler<Uno.Platform.PointerEventArgs>*/]);
}
...
{
    PointerWheelChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(PointerWheelChanged1, value), ::TYPES[6/*Uno.EventHandler<Uno.Platform.PointerEventArgs>*/]);
}
...
{
    TextInput1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(TextInput1, value), ::TYPES[7/*Uno.EventHandler<Uno.Platform.TextInputEventArgs>*/]);
}
...
{
    TextInput1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(TextInput1, value), ::TYPES[7/*Uno.EventHandler<Uno.Platform.TextInputEventArgs>*/]);
}
