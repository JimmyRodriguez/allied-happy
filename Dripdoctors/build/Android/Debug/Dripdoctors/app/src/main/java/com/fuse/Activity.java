...
public final class Activity
{
    ...
    {
        return com.apps.dripdoctors.Dripdoctors.GetRootActivity();
    }

    // - - - - - - - - - - - - - - - - - - - - - - - -

    public interface LifecycleListener extends com.apps.dripdoctors.ActivityState.AndroidLifecycleListener {}

    public static void subscribeToLifecycleChange(LifecycleListener listener)
	{
        com.apps.dripdoctors.Dripdoctors activity = (com.apps.dripdoctors.Dripdoctors)getRootActivity();
