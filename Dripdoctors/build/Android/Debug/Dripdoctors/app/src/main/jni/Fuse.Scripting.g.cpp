...
static void Marshal_build(uType* type)
{
    ...
    ::STRINGS[31] = uString::Const("C:\\ProgramData\\Uno\\Packages\\Fuse.Scripting\\0.32.14\\$.uno");
...
double Marshal::ToDouble(uObject* o)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition1(::STRINGS[30/*"Expected nu...*/], ::g::Uno::Object::GetType(uPtr(o))), 1, ::STRINGS[31/*"C:\\Program...*/], 392);
        return 0.0;
    }
}
...
uObject* ScriptModule__RequireContext::Require1(uString* id)
{
    ...
    if (module == NULL)
    {
        ...
        if (module->Error() == NULL)
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserSuccess(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[52/*"JavaScript ...*/], path), ::STRINGS[53/*" was fixed!"*/]), this, ::STRINGS[31/*"C:\\Program...*/], 204, ::STRINGS[54/*"Require"*/]);
        ...
        else
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[52/*"JavaScript ...*/], path), ::STRINGS[55/*" line "*/]), uBox<int>(::TYPES[22/*int*/], uPtr(e)->LineNumber())), ::STRINGS[56/*". "*/]), uPtr(e)->ErrorMessage()), this, ::STRINGS[31/*"C:\\Program...*/], 214, ::STRINGS[54/*"Require"*/]);
...
static void ScriptMethod1_build(uType* type)
{
    ...
    ::STRINGS[64] = uString::Const("C:\\ProgramData\\Uno\\Packages\\FuseCore\\0.32.14\\Scripting\\$.uno");
...
void ScriptMethod1__Call_fn(ScriptMethod1* __this, uObject* obj, uArray* args, uObject** __retval)
{
    ...
    if (__this->Thread == 2)
    {
        ...
        {
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[63/*"Cannot call...*/], __this, ::STRINGS[64/*"C:\\Program...*/], 129, ::STRINGS[65/*"Call"*/]);
            return *__retval = NULL, void();
        }
