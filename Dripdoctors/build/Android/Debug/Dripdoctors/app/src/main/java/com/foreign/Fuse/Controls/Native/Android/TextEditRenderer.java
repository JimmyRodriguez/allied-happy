...
public class TextEditRenderer
{
    ...
    {
        android.widget.GridLayout gridLayout = new android.widget.GridLayout(com.apps.dripdoctors.Dripdoctors.GetRootActivity());
    ...
    {
        android.widget.TextView tv = new android.widget.TextView(com.apps.dripdoctors.Dripdoctors.GetRootActivity());
