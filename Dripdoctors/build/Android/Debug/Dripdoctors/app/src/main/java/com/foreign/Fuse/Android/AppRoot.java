...
public class AppRoot
{
    ...
    {
        android.widget.RelativeLayout relativeLayout = new android.widget.RelativeLayout(com.apps.dripdoctors.Dripdoctors.GetRootActivity()) {
        		...
        		public boolean onTouchEvent(android.view.MotionEvent motionEvent) {
        			...
        			ExternedBlockHost.callUno_Fuse_Android_AppRoot_OnTouchEvent__195(motionEvent,UnoHelper.GetUnoObjectRef(motionEvent));
