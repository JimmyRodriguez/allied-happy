...
jint JNI_OnLoad(JavaVM* vm, void* reserved)
{
    ...
    jclass activityClass = env->FindClass("com/apps/dripdoctors/Dripdoctors");
    jclass entryPointsClass = env->FindClass("com/apps/dripdoctors/ActivityNativeEntryPoints");
    jclass displayClass = env->FindClass("com/apps/dripdoctors/Display");
