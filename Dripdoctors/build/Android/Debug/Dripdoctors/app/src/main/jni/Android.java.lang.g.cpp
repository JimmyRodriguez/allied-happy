...
// C:\ProgramData\Uno\Packages\Android\0.32.1\Android\java\lang\$.uno
// ------------------------------------------------------------------
...
{
    return *__retval = uCast< ::g::Android::java::lang::String*>(Object::toString_IMPL_31294(__this->_subclassed, __this->_javaObject), ::TYPES[2/*Android.java.lang.String*/]), void();
}
