...
void Console::Dir1(::g::Uno::Text::StringBuilder* builder, uObject* obj, int maxDepth, int indent)
{
    ...
    if (uIs(obj, ::TYPES[20/*Fuse.Scripting.Array*/]))
    {
        ...
        uPtr(builder)->AppendLine(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[10/*"Array["*/], uBox<int>(::TYPES[13/*int*/], uPtr(a)->Length())), ::STRINGS[11/*"]"*/]));
        ...
        if (indent <= maxDepth)
            ...
            {
                Console::Indent(builder, indent);
                uPtr(builder)->Append2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[8/*""*/], uBox<int>(::TYPES[13/*int*/], i)), ::STRINGS[9/*": "*/]));
...
void Console::Init(::g::Fuse::Scripting::Context* c)
{
    ...
    uPtr(console)->Item(::STRINGS[13/*"log"*/], uDelegate::New(::TYPES[21/*Fuse.Scripting.Callback*/], (void*)Console__Log_fn));
    console->Item(::STRINGS[14/*"dir"*/], uDelegate::New(::TYPES[21/*Fuse.Scripting.Callback*/], (void*)Console__Dir_fn));
...
static void DataBinding_build(uType* type)
{
    ...
    ::STRINGS[17] = uString::Const("Not handled: OnInsertAt");
    ::STRINGS[18] = uString::Const("Not handled: OnNewAll");
    ::STRINGS[19] = uString::Const("Not handled: OnNewAt");
    ::STRINGS[20] = uString::Const("Not handled: OnRemoveAt");
    ::STRINGS[21] = uString::Const("C:\\ProgramData\\Uno\\Packages\\Fuse.Reactive\\0.32.14\\$.uno");
    ::STRINGS[22] = uString::Const("TryPushAsMarshalledValue");
...
void DataBinding::TryPushAsMarshalledValue(uObject* newValue)
{
    ...
    if ((::g::Fuse::Scripting::Marshal__TryConvertTo1_fn(__types[1], newValue, &value, &ret3), ret3))
    {
        ...
        catch (const uThrowable& __t)
        {
            ...
            ::g::Fuse::Diagnostics::UserError(uPtr(e)->ToString(), Target(), ::STRINGS[21/*"C:\\Program...*/], 413, ::STRINGS[22/*"TryPushAsMa...*/]);
        }
    }
}
...
{
    ::STRINGS[23] = uString::Const("debug_log");
    ::STRINGS[4] = uString::Const("null");
    ::STRINGS[3] = uString::Const("C:\\ProgramData\\Uno\\Packages\\Fuse.Reactive\\0.32.14\\FuseJS\\$.uno");
    ::TYPES[1] = uObject_typeof();
    ::TYPES[21] = ::g::Fuse::Scripting::Callback_typeof();
...
{
    uPtr(uPtr(c)->GlobalObject())->Item(::STRINGS[23/*"debug_log"*/], uDelegate::New(::TYPES[21/*Fuse.Scripting.Callback*/], (void*)DebugLog__Log_fn));
}
...
static void JavaScript_build(uType* type)
{
    ...
    ::STRINGS[25] = uString::Const("JavaScript error in ");
    ::STRINGS[26] = uString::Const(" fixed!");
    ::STRINGS[21] = uString::Const("C:\\ProgramData\\Uno\\Packages\\Fuse.Reactive\\0.32.14\\$.uno");
    ::STRINGS[27] = uString::Const("EvaluateModule");
    ::STRINGS[28] = uString::Const(" line ");
    ::STRINGS[29] = uString::Const(". ");
    ::STRINGS[30] = uString::Const("Cannot require() a rooted module");
...
void JavaScript__FuseScriptingIModuleProviderGetModule_fn(JavaScript* __this, ::g::Fuse::Scripting::Module** __retval)
{
    if (__this->IsRootingCompleted())
        U_THROW(::g::Uno::Exception::New2(::STRINGS[30/*"Cannot requ...*/]));
...
uObject* JavaScript::EvaluateExports()
{
    ...
    if (_moduleResult != NULL)
        return uPtr(uPtr(_moduleResult)->Object)->Item(::STRINGS[24/*"exports"*/]);
...
void JavaScript::EvaluateModule()
{
...

    {
        ...
        if (newModuleResult->Error() == NULL)
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserSuccess(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[25/*"JavaScript ...*/], FileName()), ::STRINGS[26/*" fixed!"*/]), this, ::STRINGS[21/*"C:\\Program...*/], 1350, ::STRINGS[27/*"EvaluateMod...*/]);
        ...
        else
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[25/*"JavaScript ...*/], uPtr(se)->FileName()), ::STRINGS[28/*" line "*/]), uBox<int>(::TYPES[13/*int*/], uPtr(se)->LineNumber())), ::STRINGS[29/*". "*/]), uPtr(se)->ErrorMessage()), this, ::STRINGS[21/*"C:\\Program...*/], 1361, ::STRINGS[27/*"EvaluateMod...*/]);
...
{
    ::STRINGS[31] = uString::Const("_dispose_context");
    ::TYPES[26] = ::g::Uno::UX::Selector_typeof();
    ::TYPES[21] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[1] = uObject_typeof();
    ::TYPES[24] = ::g::Uno::UX::IPropertyListener_typeof();
...
uObject* LazyObservableProperty::Get(uArray* args)
{
    if (_observable == NULL)
    {
        ...
        uPtr(uPtr(_observable)->Object())->Item(::STRINGS[31/*"_dispose_co...*/], _obj);
        Subscribe();
    }
...
void LazyObservableProperty::Reset()
{
    ...
    if (_observable != NULL)
    {
        ...
        uPtr(uPtr(_observable)->Object())->Item(::STRINGS[31/*"_dispose_co...*/], NULL);
        _observable = NULL;
    }
}
...
{
    ::STRINGS[32] = uString::Const("addSubscriber");
    ::STRINGS[33] = uString::Const("set");
    ::STRINGS[34] = uString::Const("newAt");
    ::STRINGS[35] = uString::Const("newAll");
    ::STRINGS[36] = uString::Const("add");
    ::STRINGS[37] = uString::Const("removeAt");
    ::STRINGS[38] = uString::Const("insertAt");
    ::STRINGS[39] = uString::Const("Unhandled observable operation: ");
    ::STRINGS[40] = uString::Const("removeSubscriber");
...
void Observable::ctor_2(::g::Fuse::Reactive::ThreadWorker* worker, ::g::Fuse::Scripting::Object* obj)
{
    ...
    uPtr(obj)->CallMethod(::STRINGS[32/*"addSubscriber"*/], uArray::Init<uObject*>(::TYPES[2/*object[]*/], 1, (::g::Fuse::Scripting::Function*)_observeChange));
}
...
uObject* Observable::ObserveChange(uArray* args)
{
    ...
    if (::g::Uno::String::op_Equality(op, ::STRINGS[33/*"set"*/]))
    {
        int origin = -1;
    ...
    else if (::g::Uno::String::op_Equality(op, ::STRINGS[34/*"newAt"*/]))
    ...
    else if (::g::Uno::String::op_Equality(op, ::STRINGS[35/*"newAll"*/]))
        ...
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::STRINGS[39/*"Unhandled o...*/], op)));
...
{
    uPtr(_observable)->CallMethod(::STRINGS[40/*"removeSubsc...*/], uArray::Init<uObject*>(::TYPES[2/*object[]*/], 1, (::g::Fuse::Scripting::Function*)_observeChange));
    _observeChange = NULL;
    _observable = NULL;
}
...
{
    ::STRINGS[41] = uString::Const("_moduleFunc");
    ::STRINGS[42] = uString::Const("_dispose");
...
{
    uPtr(__this->_self)->Item(::STRINGS[41/*"_moduleFunc"*/], moduleFunc);
    uPtr(__this->_self)->CallMethod(::STRINGS[41/*"_moduleFunc"*/], args);
}
...
void RootableScriptModule::EnsureRooted(::g::Fuse::Scripting::Context* context)
{
    ...
    uPtr(_self)->Item(::STRINGS[42/*"_dispose"*/], uPtr(context)->NewArray(uArray::New(::TYPES[2/*object[]*/], 0)));
...
void RootableScriptModule::Unroot()
{
    ...
    ::g::Fuse::Scripting::Array* disposeList = uAs< ::g::Fuse::Scripting::Array*>(uPtr(_self)->Item(::STRINGS[42/*"_dispose"*/]), ::TYPES[20/*Fuse.Scripting.Array*/]);
    ...
    if (disposeList != NULL)
    {
        ...
        uPtr(_self)->Item(::STRINGS[42/*"_dispose"*/], NULL);
        _self = NULL;
    }
...
static void SegmentObserver_build(uType* type)
{
    ...
    ::STRINGS[45] = uString::Const("Cannot access disposed PathSubscription");
    ::STRINGS[46] = uString::Const("Data binding to '");
    ::STRINGS[47] = uString::Const("': expected single value, got array");
    ::STRINGS[48] = uString::Const("': expected single value, got array of length ");
    ::TYPES[22] = ::g::Uno::IDisposable_typeof();
    ::TYPES[23] = ::g::Fuse::Reactive::Observable_typeof();
...
{
    if (_isDisposed)
        U_THROW(::g::Uno::Exception::New2(::STRINGS[45/*"Cannot acce...*/]));
...
void SegmentObserver::OnAdd(uObject* addedValue)
{
    ...
    U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[46/*"Data bindin...*/], _key), ::STRINGS[47/*"': expected...*/])));
}
...
void SegmentObserver::OnNewAll(::g::Fuse::Reactive::ListMirror* values)
{
    ...
    if (uPtr(values)->Length() > 0)
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[46/*"Data bindin...*/], _key), ::STRINGS[48/*"': expected...*/]), uBox<int>(::TYPES[13/*int*/], uPtr(values)->Length()))));
}
...
uString* SegmentObserver::CombineKeyAndPath(uString* key, uString* path)
{
    if (::g::Uno::String::op_Inequality(path, NULL) && (uPtr(path)->Length() > 0))
        return ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(key, ::STRINGS[44/*"."*/]), path);
    else
        return key;
}
...
{
    ::STRINGS[49] = uString::Const("setValueWithOrigin");
    ::TYPES[0] = ::g::Fuse::Reactive::IObserver_typeof();
    ::TYPES[43] = ::g::Fuse::Reactive::ListMirror_typeof();
    ::TYPES[2] = uObject_typeof()->Array();
    ::TYPES[1] = uObject_typeof();
...
{
    uPtr(uPtr(_om)->Object())->CallMethod(::STRINGS[49/*"setValueWit...*/], uArray::Init<uObject*>(::TYPES[2/*object[]*/], 2, (uObject*)::g::Fuse::Reactive::ValueMirror::Unbox(newValue), uBox<int>(::TYPES[13/*int*/], _origin)));
}
...
static void ThreadWorker_build(uType* type)
{
    ...
    ::STRINGS[52] = uString::Const("JavaScript data model contains circular references or is too deep. Some data may not display correctly.");
    ::STRINGS[53] = uString::Const("CreateMirror");
    ::STRINGS[54] = uString::Const("external_object");
    ::STRINGS[55] = uString::Const("(class)");
    ::STRINGS[56] = uString::Const("(function(external_object) { this.external_object = external_object; })");
    ::STRINGS[57] = uString::Const("(set-superclass)");
    ::STRINGS[58] = uString::Const("(function(cl, superclass) { cl.prototype = new superclass(); cl.prototype.constructor = cl; })");
    ::STRINGS[59] = uString::Const("(func)");
    ::STRINGS[60] = uString::Const("(function (cl, callback) { cl.prototype.");
    ::STRINGS[61] = uString::Const(" = function() { callback(this.external_object, Array.prototype.slice.call(arguments)); }})");
...
void ThreadWorker::CheckAndThrow()
{
    ...
    {
        if (prev != NULL)
            ::g::Fuse::Diagnostics::UnknownException(::STRINGS[50/*"Skipped Exc...*/], next, this, ::STRINGS[21/*"C:\\Program...*/], 2613, ::STRINGS[51/*"CheckAndThrow"*/]);
...
::g::Fuse::Reactive::ValueMirror* ThreadWorker::CreateMirror(uObject* obj)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserWarning(::STRINGS[52/*"JavaScript ...*/], this, ::STRINGS[21/*"C:\\Program...*/], 2778, ::STRINGS[53/*"CreateMirror"*/]);
        return NULL;
    }
...
uObject* ThreadWorker::Reflect(uObject* obj)
{
    ...
    if (sobj != NULL)
    {
        if (uPtr(sobj)->ContainsKey(::STRINGS[54/*"external_ob...*/]))
        {
            ::g::Fuse::Scripting::External* ext = uAs< ::g::Fuse::Scripting::External*>(uPtr(sobj)->Item(::STRINGS[54/*"external_ob...*/]), ::TYPES[40/*Fuse.Scripting.External*/]);
...
{
    ::g::Fuse::Scripting::Function* cl = uCast< ::g::Fuse::Scripting::Function*>(uPtr(ThreadWorker::_context())->Evaluate(::STRINGS[55/*"(class)"*/], ::STRINGS[56/*"(function(e...*/]), ::TYPES[18/*Fuse.Scripting.Function*/]);
    ...
    if (uPtr(sc)->SuperType() != NULL)
    {
        ...
        if (_setSuperclass == NULL)
            _setSuperclass = uCast< ::g::Fuse::Scripting::Function*>(uPtr(ThreadWorker::_context())->Evaluate(::STRINGS[57/*"(set-superc...*/], ::STRINGS[58/*"(function(c...*/]), ::TYPES[18/*Fuse.Scripting.Function*/]);
    ...
    for (int i = 0; i < uPtr(uPtr(sc)->Methods())->Length(); i++)
    {
        ...
        ::g::Fuse::Scripting::Function* factory = uCast< ::g::Fuse::Scripting::Function*>(uPtr(ThreadWorker::_context())->Evaluate(::STRINGS[59/*"(func)"*/], ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[60/*"(function (...*/], methodName), ::STRINGS[61/*" = function...*/])), ::TYPES[18/*Fuse.Scripting.Function*/]);
...
void ThreadWorker::Run()
{
    ...
    {
        ::g::Uno::Exception* e = __t.Exception;
        ::g::Fuse::Diagnostics::UnknownException(::STRINGS[62/*"ThreadWorke...*/], e, this, ::STRINGS[21/*"C:\\Program...*/], 2501, ::STRINGS[63/*"Run"*/]);
