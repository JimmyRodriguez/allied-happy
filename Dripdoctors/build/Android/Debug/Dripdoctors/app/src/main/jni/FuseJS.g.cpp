...
// C:\ProgramData\Uno\Packages\FuseJS\0.32.14\$.uno
// ------------------------------------------------
...
static void RaiseEvent_build(uType* type)
{
    ...
    ::STRINGS[38] = uString::Const("C:\\ProgramData\\Uno\\Packages\\FuseJS\\0.32.14\\$.uno");
...
void RaiseEvent::Raise()
{
    ...
    if (dispatch == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[37/*"Cannot find...*/], Name), this, ::STRINGS[38/*"C:\\Program...*/], 627, ::STRINGS[39/*"Raise"*/]);
        return;
    }
...
uObject* UserEvents::Raise(::g::Fuse::Scripting::Context* context, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::Deprecated(::STRINGS[42/*"The FuseJS/...*/], context, ::STRINGS[38/*"C:\\Program...*/], 658, ::STRINGS[39/*"Raise"*/]);
