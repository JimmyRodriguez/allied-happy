...
namespace g{struct Dripdoctors_FuseControlsImage_Width_Property;}
...
struct Dripdoctors_FuseControlsImage_Width_Property : ::g::Uno::UX::Property1
{
    uStrong< ::g::Fuse::Controls::Image*> _obj;

    void ctor_2(::g::Fuse::Controls::Image* obj, ::g::Uno::UX::Selector name);
    static Dripdoctors_FuseControlsImage_Width_Property* New1(::g::Fuse::Controls::Image* obj, ::g::Uno::UX::Selector name);
};
// }
