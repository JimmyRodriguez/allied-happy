...
public class Dripdoctors extends android.app.Activity implements ActivityCompat.OnRequestPermissionsResultCallback
{
    ...
    {
    	Dripdoctors activity = _appState.CurrentActivity;
