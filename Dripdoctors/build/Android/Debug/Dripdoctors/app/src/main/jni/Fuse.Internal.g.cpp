...
// C:\ProgramData\Uno\Packages\FuseCore\0.32.14\Internal\$.uno
// -----------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\Fuse.Elements\0.32.14\Internal\$.uno
// ----------------------------------------------------------------
...
void ImageContainer::OnParamChanged()
{
    ...
    if (_owner != NULL)
        ::g::Fuse::Internal::IImageContainerOwner::OnParamChanged(uInterface(uPtr(_owner), ::TYPES[6/*Fuse.Internal.IImageContainerOwner*/]));
}
...
void ImageContainer::OnSizingChanged()
{
    ...
    if (_owner != NULL)
        ::g::Fuse::Internal::IImageContainerOwner::OnSizingChanged(uInterface(uPtr(_owner), ::TYPES[6/*Fuse.Internal.IImageContainerOwner*/]));
}
