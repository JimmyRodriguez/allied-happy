...
struct IObserver
{
    ...
    void(*fp_OnNewAll)(uObject*, ::g::Fuse::Reactive::ListMirror*);
    ...
    static void OnNewAll(const uInterface& __this, ::g::Fuse::Reactive::ListMirror* values) { __this.VTable<IObserver>()->fp_OnNewAll(__this, values); }
