...
public class MediaPlayer
{
    ...
    {
        android.view.Window window = com.apps.dripdoctors.Dripdoctors.GetRootActivity().getWindow();
        ...
        try
        {
        	android.content.pm.ActivityInfo info = com.apps.dripdoctors.Dripdoctors.GetRootActivity().getPackageManager().getActivityInfo(com.apps.dripdoctors.Dripdoctors.GetRootActivity().getComponentName(), 0);
    ...
    public static void LoadAsyncAsset170(final Object _this, final Object handle,final String assetName)
    {
        ...
        try
        {
        	afd = com.apps.dripdoctors.Dripdoctors
        		.GetRootActivity()
        		.getAssets()
        		.openFd(assetName);
        }
    ...
    public static void Pause1173(final Object handle)
    {
        ...
        if (player.isPlaying())
        {
        	android.media.AudioManager am = (android.media.AudioManager)com.apps.dripdoctors.Dripdoctors.GetRootActivity().getSystemService(android.content.Context.AUDIO_SERVICE);
