...
{
    uArray* Vertices_311c1aa8_1_1_0 = uArray::Init< ::g::Uno::Float2>(::TYPES[32/*float2[]*/], 5, ::g::Uno::Float2__New2(0.0f, 0.0f), ::g::Uno::Float2__New2(0.0f, 1.0f), ::g::Uno::Float2__New2(1.0f, 1.0f), ::g::Uno::Float2__New2(1.0f, 0.0f), ::g::Uno::Float2__New2(0.0f, 0.0f));
...
static void UserEvent_build(uType* type)
{
    ...
    ::STRINGS[47] = uString::Const("C:\\ProgramData\\Uno\\Packages\\Fuse.UserEvents\\0.32.14\\$.uno");
...
void UserEvent__OnRooted_fn(UserEvent* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[46/*"UserEvent r...*/], __this, ::STRINGS[47/*"C:\\Program...*/], 480, ::STRINGS[48/*"OnRooted"*/]);
        return;
    }
...
void UserEvent::Raise(::g::Uno::Collections::Dictionary* args)
{
    if (Dispatch == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[51/*"Trying to R...*/], this, ::STRINGS[47/*"C:\\Program...*/], 523, ::STRINGS[52/*"Raise"*/]);
        return;
    }
...
void UserEvent::raise(UserEvent* n, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[49/*"Raise must ...*/], n, ::STRINGS[47/*"C:\\Program...*/], 325, ::STRINGS[45/*"raise"*/]);
        return;
    }
    ...
    if (so == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[50/*"Raise must ...*/], uPtr(args)->Strong<uObject*>(0), ::STRINGS[47/*"C:\\Program...*/], 332, ::STRINGS[45/*"raise"*/]);
        return;
    }
...
static void Visual_build(uType* type)
{
    ...
    ::TYPES[118] = ::g::Uno::Action2_typeof()->MakeType(uObject_typeof(), uObject_typeof());
    ::TYPES[119] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Uno::UX::Resource_typeof());
    ::TYPES[120] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Uno::UX::Resource_typeof());
    ::TYPES[14] = ::g::Uno::Action_typeof();
    ::TYPES[121] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Node_typeof());
    ...
    ::TYPES[126] = ::g::Uno::Collections::ObservableList_typeof()->MakeType(::g::Uno::UX::Template_typeof());
    ::TYPES[127] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::UX::Template_typeof());
...
void Visual__TryGetResource_fn(Visual* __this, uString* key, uDelegate* acceptor, uObject** resource, bool* __retval)
{
    ...
    if (__this->HasResources())
    {
        ...
        for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(resources), ::TYPES[119/*Uno.Collections.ICollection<Uno.UX.Resource>*/])); i++)
        {
            ::g::Uno::UX::Resource* r = (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(resources), ::TYPES[120/*Uno.Collections.IList<Uno.UX.Resource>*/]), uCRef<int>(i), &ret43), ret43);
...
{
    uPtr(Properties())->Set(Visual::_layerProperty(), uBox<int>(::TYPES[122/*Fuse.Layer*/], value));
    InvalidateLayout(2);
}
...
{
    uPtr(Properties())->Set(Visual::_layoutRoleProperty(), uBox<int>(::TYPES[123/*Fuse.LayoutRole*/], value));
    InvalidateLayout(2);
}
...
void Visual::OnTemplatesChanged(::g::Uno::UX::Template* t)
{
    ...
    if (IsRootingCompleted())
        ...
        for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
        {
            uObject* to = uAs<uObject*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Children()), ::TYPES[60/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret35), ret35), ::TYPES[117/*Fuse.ITemplateObserver*/]);
...
void Visual::SetResource(uString* key, uObject* value)
{
    ...
    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(resources), ::TYPES[119/*Uno.Collections.ICollection<Uno.UX.Resource>*/])); ++i)
    {
        ::g::Uno::UX::Resource* r = (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(resources), ::TYPES[120/*Uno.Collections.IList<Uno.UX.Resource>*/]), uCRef<int>(i), &ret41), ret41);

        if (::g::Uno::String::op_Equality(uPtr(r)->Key(), key))
        {
            ::g::Uno::Collections::IList::RemoveAt(uInterface(uPtr(resources), ::TYPES[120/*Uno.Collections.IList<Uno.UX.Resource>*/]), i);
            break;
        }
    }

    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(resources), ::TYPES[119/*Uno.Collections.ICollection<Uno.UX.Resource>*/]), ::g::Uno::UX::Resource::New1(key, value));
}
...
static void VisualEvent_build(uType* type)
{
    ...
    ::TYPES[4] = ::g::Uno::Exception_typeof();
    ::TYPES[11] = ::g::Fuse::Visual_typeof();
    ::TYPES[130] = ::g::Fuse::VisualEventArgs_typeof();
    ::TYPES[131] = ::g::Uno::Action2_typeof()->MakeType(uObject_typeof(), uObject_typeof()->Array());
    ::TYPES[95] = uObject_typeof()->Array();
    ::TYPES[15] = ::g::Uno::Delegate_typeof();
    ::TYPES[132] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Visual_typeof());
    type->SetPrecalc(
...
void VisualEvent::Raise(::g::Fuse::VisualEventArgs* args, int type, bool bubble, uDelegate* PostBubbleAction)
{
    ...
    switch (type)
    {
        case 0:
        {
            handler = uDelegate::New(::TYPES[131/*Uno.Action<object, object[]>*/], (void*)VisualEvent__OnRaise_fn, this);
            break;
        }
        case 2:
        {
        ...
        case 1:
        {
            handler = uDelegate::New(::TYPES[131/*Uno.Action<object, object[]>*/], (void*)VisualEvent__OnRaiseEnabled_fn, this);
            break;
        }
        default:
        {
            ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[59/*"Invalid Rai...*/], 1, ::STRINGS[1/*"C:\\Program...*/], 1652);
            return;
        }
    }
